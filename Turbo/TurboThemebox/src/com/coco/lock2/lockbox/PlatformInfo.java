...
public class PlatformInfo
{
			...
			Context context )
	{
		...
		if( isSupportViewLock() || !"true".equals( lockV ) )
		{
			setComponentEnabled( pkgMgr , new ComponentName( context , LockService.class ) , PackageManager.COMPONENT_ENABLED_STATE_DISABLED );
			setComponentEnabled( pkgMgr , new ComponentName( context , LockHomeActivity.class ) , PackageManager.COMPONENT_ENABLED_STATE_DISABLED );
		}
		else
		{
			setComponentEnabled( pkgMgr , new ComponentName( context , LockService.class ) , PackageManager.COMPONENT_ENABLED_STATE_ENABLED );
			setComponentEnabled( pkgMgr , new ComponentName( context , LockHomeActivity.class ) , PackageManager.COMPONENT_ENABLED_STATE_ENABLED );
		}
	}
