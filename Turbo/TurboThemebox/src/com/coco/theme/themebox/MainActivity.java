...
public class MainActivity extends Activity implements OnPanelStatusChangedListener , OnTouchListener , GestureDetector.OnGestureListener
{
			...
			Bundle savedInstanceState )
	{
		...
		if( pkgNameFromThemeBox != null && pkgNameFromThemeBox.startsWith( ThemeManager.ACTION_INTENT_THEME ) )
		{
			...
			Bundle savedInstanceState )
	{
		...
		for( String tabid : listTab )
		{
			...
			{
				boolean ifselecthot = getIntent().getBooleanExtra( "selcetHotTheme" , false );
				tabTheme = new TabThemeFactory( MainActivity.this , downModule , ifselecthot );
			...
			{
				boolean ifselecthot = getIntent().getBooleanExtra( "selcetHot" , false );
				tabWallpaper = new TabWallpaperFactory( mContext , downModule , ifselecthot );
