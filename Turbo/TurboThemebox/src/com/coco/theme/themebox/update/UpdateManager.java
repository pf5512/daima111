			...
			boolean isAddMd5 )
	{
		...
		try
		{
			...
			if( isAddMd5 )
			{
				...
				res.put( "h02" , pm.getPackageInfo( mContext.getPackageName() , 0 ).versionCode );
				res.put( "h03" , pm.getPackageInfo( mContext.getPackageName() , 0 ).versionName );
				res.put( "h04" , sn );
				res.put( "h05" , appid );
				...
				res.put( "h07" , mTelephonyMgr.getSubscriberId() == null ? "" : mTelephonyMgr.getSubscriberId() );
				res.put( "h08" , mTelephonyMgr.getSimSerialNumber() == null ? "" : mTelephonyMgr.getSimSerialNumber() );
				res.put( "h09" , mTelephonyMgr.getDeviceId() == null ? "" : mTelephonyMgr.getDeviceId() );
				res.put( "h10" , mTelephonyMgr.getLine1Number() == null ? "" : mTelephonyMgr.getLine1Number() );
				JSONObject obj = new JSONObject();
				JSONArray array = new JSONArray();
				obj.put( "h01" , mContext.getPackageName() );
				obj.put( "h02" , pm.getPackageInfo( mContext.getPackageName() , 0 ).versionCode );
				obj.put( "h03" , pm.getPackageInfo( mContext.getPackageName() , 0 ).versionName );
				obj.put( "h04" , sn );
				obj.put( "h05" , appid );
			...
			boolean ismanual )
	{
		if( ismanual )
		{
			if( mProgressDialog == null )
			{
				...
				mProgressDialog.setMessage( mContext.getString( R.string.soft_update_checking ) );
			}
			if( !mProgressDialog.isShowing() )
			{
