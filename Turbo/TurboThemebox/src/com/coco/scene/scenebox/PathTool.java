...
public class PathTool
{
	...
	public static String getSceneDir()
	{
		...
		{
			return com.coco.theme.themebox.StaticClass.set_directory_path + custom_sdcard_root_path + "Scene/";
		}
		return Environment.getExternalStorageDirectory().getAbsolutePath() + custom_sdcard_root_path + "Scene/";
	}
	...
	public static String getRecommendDir()
	{
		if( !com.coco.theme.themebox.StaticClass.set_directory_path.equals( "" ) )
		{
			return com.coco.theme.themebox.StaticClass.set_directory_path + custom_sdcard_root_path + "Scene/recommend";
		}
		return Environment.getExternalStorageDirectory().getAbsolutePath() + custom_sdcard_root_path + "Scene/recommend";
	}
			...
			String packageName )
	{
		if( !com.coco.theme.themebox.StaticClass.set_directory_path.equals( "" ) )
		{
			return com.coco.theme.themebox.StaticClass.set_directory_path + custom_sdcard_root_path + "Scene/Image/" + packageName;
		}
		return Environment.getExternalStorageDirectory().getAbsolutePath() + custom_sdcard_root_path + "Scene/Image/" + packageName;
	}
	...
	public static String getDownloadingDir()
	{
		if( !com.coco.theme.themebox.StaticClass.set_directory_path.equals( "" ) )
		{
			return com.coco.theme.themebox.StaticClass.set_directory_path + custom_sdcard_root_path + "Scene/Downloading";
		}
		return Environment.getExternalStorageDirectory().getAbsolutePath() + custom_sdcard_root_path + "Scene/Downloading";
	}
	...
	public static String getAppDir()
	{
		if( !com.coco.theme.themebox.StaticClass.set_directory_path.equals( "" ) )
		{
			return com.coco.theme.themebox.StaticClass.set_directory_path + custom_sdcard_root_path + "Scene/App";
		}
		return Environment.getExternalStorageDirectory().getAbsolutePath() + custom_sdcard_root_path + "Scene/App";
	}
	...
	public static String getTempDir()
	{
		if( !com.coco.theme.themebox.StaticClass.set_directory_path.equals( "" ) )
		{
			return com.coco.theme.themebox.StaticClass.set_directory_path + custom_sdcard_root_path + "Scene/Temp";
		}
		return Environment.getExternalStorageDirectory().getAbsolutePath() + custom_sdcard_root_path + "Scene/Temp";
	}
