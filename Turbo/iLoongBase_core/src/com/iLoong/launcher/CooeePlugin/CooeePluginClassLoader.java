 ...
 * remove them.
 */
public class CooeePluginClassLoader extends PathClassLoader {

	public CooeePluginClassLoader(String dexPath, String dexOutputDir,
			String libPath, ClassLoader parent) {
		super(dexPath, libPath, parent);
