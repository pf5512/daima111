package com.thirdParty.pinyin4j.hp.hpl.sparta;

import java.io.*;
import java.util.*;

import com.thirdParty.pinyin4j.hp.hpl.sparta.xpath.*;
...
public class Document extends Node {
  ...
  public class Index implements Observer {
    ...
    /**
     * @see com.thirdParty.pinyin4j.hp.hpl.sparta.Document.Observer#update(Document)
     */
