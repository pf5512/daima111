...
public class ShortcutInfo extends ItemInfo
{
	...
	public boolean hotseatDefaultIcon = false;
	/**
	...
	// this available holds the path of bitmap
	// it means that you have to assign a value to this available manually when you create a new 
	// instance of{@link #Icon3D}
			...
			ShortcutInfo info )
	{
		...
		//if(DefaultLayout.mainmenu_folder_function == true) // no need mainmenu folder condition
		{
			flags = info.flags;
			...
			ApplicationInfo info )
	{
		...
		this.extendible_flag = info.extendible_flag;
			...
			IconCache iconCache )
	{
		...
		if( usingFallbackIcon && customIcon )
		{
			Bitmap bmp = LauncherModel.getBitmapFromDB( iLoongLauncher.getInstance() , this );
			if( bmp != null )
				mIcon = bmp;
		}
		return mIcon;
