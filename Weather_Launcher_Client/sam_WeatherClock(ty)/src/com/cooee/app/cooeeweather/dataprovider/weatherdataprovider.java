...
public class weatherdataprovider extends ContentProvider {
    ...
    public static String AUTHORITY = "com.cooee.app.cooeeweather.dataprovider";
    //20130709-liuhailin
    // table weather name
  ...
  //20130709-liuhailin-<auto change DB_PATH>
    //private static final String DB_PATH = "/data/data/com.cooee.widget.samweatherclock/databases/";
    private static String DB_PATH = "/data/data/com.cooee.widget.samweatherclock/databases/";
  //20130709-liuhailin
...
/*    private static void deleteDatabase(Context context) {
    ...
    public boolean onCreate() {
    	...
    	AUTHORITY = getContext().getResources().getString(R.string.provider_authorities);
