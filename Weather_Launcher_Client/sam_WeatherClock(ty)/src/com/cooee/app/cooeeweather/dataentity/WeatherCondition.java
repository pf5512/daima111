...
public class WeatherCondition {
    ...
    private final static String des[][] = {
            { // 晴朗
                    "晴", "以晴为主", "晴间多云", "Clear", "Sunny", "Fine", "Mostly Sunny",
                    "Partly Sunny"
            }, { // 多云
                    "多云", "局部多云", "Mostly Cloudy", "Partly Cloudy", "Cloudy"
            }, { // 雾霾
                    "雾霾", "烟雾", "沙尘暴", "浮尘", "扬沙", "强沙尘暴", "Smoke", "Haze"
            }, { // 阴
                    "阴", "Overcast"
            }, { // 雪
                    ...
                    "小雨", "可能有雨", "可能有暴风雨", "Chance of Rain", "Chance of Storm",
                    "Light rain"
            }, { // 中雨
    ...
    public static Condition convertCondition(String s) {
