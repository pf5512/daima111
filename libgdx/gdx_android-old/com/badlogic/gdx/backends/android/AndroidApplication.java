...
public class AndroidApplication extends Activity implements Application
{
	...
	public volatile boolean hasFocus = true;
	public volatile boolean justResume = false;
	public volatile boolean releaseGL = false;
	public volatile boolean optTouch = false;
	...
	protected void onPause()
	{
		...
		if( graphics != null && graphics.view != null && ( isFinishing() || releaseGL ) )
		{
			...
			if( graphics.view instanceof GLSurfaceView )
	...
	public void postUrgentRunnable(
			Runnable runnable )
	{
		//Log.e("anr", "post 1");
