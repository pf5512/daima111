...
public class Installation
{
			...
			Context context )
	{
		...
		//UUID deviceUuid2 = new UUID(androidId.hashCode(), ((long)tmDevice.hashCode() << 32) | tmSerial.hashCode());
		UUID deviceUuid = new UUID( androidId.hashCode() , androidId.hashCode() );
		String uniqueId = deviceUuid.toString();
		//String uniqueId2 = deviceUuid2.toString();
		//Log.v("statistics", "uniqueId:" + uniqueId + " uniqueId2 = " + uniqueId2);
		//Log.v("statistics", "tmDevice:" + tmDevice + " tmSerial = " + tmSerial+" androidId = "+androidId);
		return uniqueId;
	}
