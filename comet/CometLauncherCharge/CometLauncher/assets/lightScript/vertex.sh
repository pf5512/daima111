...
uniform vec3 uLightDirction;		//光源的方向
...
void pointLight(					//定位光光照计算的方法
  ...
  //计算从表面点到光源位置的向量vp
  vec3 vp= normalize(lightDirction);  
...
void main()
{
   ...
   pointLight(normalize(a_normal),ambientTemp,diffuseTemp,specularTemp,uLightDirction,
   vec4(0.3,0.3,0.3,1.0),vec4(1.5,1.5,1.5,1.0),vec4(1.0,1.0,1.0,1.0));   
