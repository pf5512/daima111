...
public class SceneSettingAction extends Action
{
	...
	{
		SetupMenuActions.getInstance().RegisterAction( ActionSetting.ACTION_SETTING_SYSTEM , new SceneSettingAction( ActionSetting.ACTION_SETTING_SYSTEM , SceneSettingAction.class.getName() ) );
	}
	...
	protected void OnRunAction()
	{
		...
		SetupMenuActions.getInstance().ActivityFinish( ActionSetting.ACTION_SETTING_SYSTEM );
	}
