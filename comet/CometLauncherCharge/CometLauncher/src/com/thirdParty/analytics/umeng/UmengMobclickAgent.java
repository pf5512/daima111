...
public class UmengMobclickAgent
{
	...
	public static final String EVENT_ID_ENTRYPRIMEADS = "EntryPrimeADS";
	public static final String EVENT_ID_DOWNLOADWIDGET="Widget_Download";
	public static final String EVENT_ID_UPDATE="Update";
	...
	public static final String Type[] = { "CONTENT_TYPE_PHOTO_BUCKET" , "CONTENT_TYPE_AUDIO_ALBUM" , "CONTENT_TYPE_VIDEO" , };
	
	//每天执行一次函数
	public static void OnceEvent(
			Context content )
	{
