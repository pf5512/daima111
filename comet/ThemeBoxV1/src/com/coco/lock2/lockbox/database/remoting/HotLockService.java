...
public class HotLockService {
	...
	public static final String TABLE_NAME = "hotLock";
	...
	public HotLockService(Context context) {
		mContext = context;
	}
	...
	public LockInfoItem queryByPackageName(String packageName) {
	...
	public boolean batchInsert(List<LockInfoItem> lockList) {
