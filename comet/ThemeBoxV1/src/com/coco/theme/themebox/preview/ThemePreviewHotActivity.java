	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		btnApply.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				if(StatisticsExpand.getEnableStatisticsInLauncher() == true)
				{
					StatisticsExpand.LauncherApplyTheme(mContext, packageName);
				}
				//xiatian add end
		...
		relativeDownload.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (relativeDownload.findViewById(R.id.linearDownload)
					...
					if(StatisticsExpand.getEnableStatisticsInLauncher() == true)
					{
						StatisticsExpand.LauncherContinueDownTheme(mContext, packageName);
					}
					//xiatian add end
		...
		btnDown.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (dItem == null) {
					...
					if(StatisticsExpand.getEnableStatisticsInLauncher() == true)
					{
						StatisticsExpand.LauncherStartDownTheme(mContext, packageName);
					}
					//xiatian add end
		...
		btnDelete.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				if(StatisticsExpand.getEnableStatisticsInLauncher() == true)
				{
					StatisticsExpand.LauncherDeleteTheme(mContext, packageName);
				}
				//xiatian add end
		...
		btnUninstall.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				if(StatisticsExpand.getEnableStatisticsInLauncher() == true)
				{
					StatisticsExpand.LauncherUninstallTheme(mContext, packageName);
				}
				//xiatian add end
