...
public class PathTool {
	...
	public static String getThemeDir() {
		if (com.coco.theme.themebox.StaticClass.canDownToInternal) {
			return com.coco.theme.themebox.StaticClass.INTERNAL_PATH + "/Coco/Theme/";
		}
	...
	public static String getImageDir(String packageName) {
		if (com.coco.theme.themebox.StaticClass.canDownToInternal) {
			return com.coco.theme.themebox.StaticClass.INTERNAL_PATH + "/Coco/Theme/Image/" + packageName;
		}
		return Environment.getExternalStorageDirectory().getAbsolutePath()
				+ "/Coco/Theme/Image/" + packageName;
	}

	public static String getDownloadingDir() {
		if (com.coco.theme.themebox.StaticClass.canDownToInternal) {
			return com.coco.theme.themebox.StaticClass.INTERNAL_PATH + "/Coco/Theme/Downloading";
		}
		return Environment.getExternalStorageDirectory().getAbsolutePath()
				+ "/Coco/Theme/Downloading";
	}

	public static String getAppDir() {
		if (com.coco.theme.themebox.StaticClass.canDownToInternal) {
			return com.coco.theme.themebox.StaticClass.INTERNAL_PATH + "/Coco/Theme/App";
		}
		return Environment.getExternalStorageDirectory().getAbsolutePath()
				+ "/Coco/Theme/App";
	}
	...
	public static String getTempDir() {
		if (com.coco.theme.themebox.StaticClass.canDownToInternal) {
			return com.coco.theme.themebox.StaticClass.INTERNAL_PATH + "/Coco/Theme/Temp";
		}
		return Environment.getExternalStorageDirectory().getAbsolutePath()
				+ "/Coco/Theme/Temp";
	}
	...
	public static void makeDirApp() {
		try {
			...
			new File(getThemeDir(), ".nomedia").createNewFile();
