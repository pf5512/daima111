...
public class StaticClass {
	...
	public static final String INTERNAL_PATH = "/mnt/internal/cooee_lock";
	...
	public static final String ACTION_HOTLIST_CHANGED = "com.coco.theme.action.HOTLIST_CHANGED";
	...
	public static boolean isAllowDownload(Context cxt) {
	...
	public static boolean isAllowDownloadWithToast(Context cxt) {
		if (!Environment.getExternalStorageState().equals(
				Environment.MEDIA_MOUNTED) && !canDownToInternal) {
			Toast.makeText(cxt, cxt.getString(R.string.textSdCardNotPrepare), 
