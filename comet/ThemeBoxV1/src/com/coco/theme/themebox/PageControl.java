...
public class PageControl extends LinearLayout
{
	...
	public void setPageCount(int pageCount)
	{
		...
		for(int i=0;i<pageCount;i++)
		{
			...
			LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(21, 4);
	...
	public void setCurrentPage(int currentPage)
	{
		...
		{
			Bitmap nopress = BitmapFactory.decodeResource(mContext.getResources(), R.drawable.scroll_nopress);
			Bitmap press = BitmapFactory.decodeResource(mContext.getResources(), R.drawable.scroll_press);
