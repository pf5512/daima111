...
public class HotThemeService {
	...
	public static String getCreateSql() {
		String result = String
				.format("CREATE TABLE %s (%s TEXT PRIMARY KEY, %s TEXT, %s INTEGER, %s TEXT, %s INTEGER, %s TEXT, %s TEXT, %s TEXT);",
						TABLE_NAME, FIELD_PACKAGE_NAME, FIELD_APPLICATION_NAME,
	...
	public ThemeInfoItem queryByPackageName(String packageName) {
