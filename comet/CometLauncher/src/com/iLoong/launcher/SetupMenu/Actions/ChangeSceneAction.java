...
public class ChangeSceneAction extends Action
{
			...
			String action )
	{
		...
		putIntentAction( SetupMenu.getContext() , com.iLoong.launcher.scene.SceneManagerActivity.class );
	}
	
	public static void Init()
	{
		SetupMenuActions.getInstance().RegisterAction( ActionSetting.ACTION_CHANGE_SCENE , new ChangeSceneAction( ActionSetting.ACTION_CHANGE_SCENE , ChangeSceneAction.class.getName() ) );
	}
