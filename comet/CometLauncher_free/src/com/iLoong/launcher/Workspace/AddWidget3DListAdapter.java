			...
			iLoongLauncher launcher )
	{
		...
		for( ResolveInfo resolve : mWidgetResolveInfoList )
		{
			try
			{
				...
				Context widgetPluginContext = iLoongApplication.ctx.createPackageContext( resolve.activityInfo.packageName , Context.CONTEXT_INCLUDE_CODE | Context.CONTEXT_IGNORE_SECURITY );
