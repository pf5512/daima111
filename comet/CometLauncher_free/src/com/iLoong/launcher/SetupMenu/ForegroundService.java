...
public class ForegroundService extends Service
{
			...
			int startId )
	{
		...
		{
			Notification localNotification = new Notification( 0 , "CometLauncher Start" , System.currentTimeMillis() );
			localNotification.setLatestEventInfo( this , "CometLauncher" , "CometLauncher Start" , PendingIntent.getActivity( this , 0 , new Intent( this , iLoongLauncher.class ) , 0 ) );
