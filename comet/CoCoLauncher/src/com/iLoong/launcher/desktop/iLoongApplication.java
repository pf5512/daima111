...
public class iLoongApplication extends Application {
	...
	public void onCreate() {
		...
		// enable_themebox
		init = true;
		com.coco.theme.themebox.service.ThemesDB.LAUNCHER_PACKAGENAME = RR
				.getPackageName();
	...
	public LauncherModel setLauncher(iLoongLauncher launcher) {
	...
	public static String getBackupPath() {
		...
		if (sd == null)
			return null;
		String backup = "/coco/backup/"
				+ iLoongApplication.getInstance().getPackageName();
