...
public class GS4 {
	...
	public static void updateEffect(ViewGroup3D pre_view, ViewGroup3D cur_view, ViewGroup3D next_view, float scroll_degree, float this_width, boolean is_Thumbnail)
	{
		Color color;
		float distance;
		if (is_Thumbnail) {
