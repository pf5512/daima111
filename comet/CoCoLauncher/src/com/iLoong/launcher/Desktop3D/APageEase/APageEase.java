...
//teapotXu_20130306: add end
	...
	public static final int COOLTOUCH_EFFECT_MAX = 33; 
	...
	public static void setTouchUpAnimEffectStatus(boolean is_touch_up_effect)
	{
		is_anim_effect_shown_whn_touch_up = is_touch_up_effect;
	}
	
	// save the original degree when touch up
	public static void saveDegreeInfoWhnTouchUp(float degree_touch_up)
	{
		original_degree_whn_touch_up = degree_touch_up;
	}	
	//teapotXu_20130307: add end

	public static void updateEffect(ViewGroup3D cur_view,ViewGroup3D next_view,float degree,float yScale,int type)
	{
...
//			type = COOLTOUCH_EFFECT_MELT;
		...
		default:
			Default.updateEffect(cur_view, next_view, degree, yScale, this_width, is_standard);
			break;
...
//			break;
	...
	public static void updateEffect(ViewGroup3D pre_view, ViewGroup3D cur_view, ViewGroup3D next_view, float degree, boolean is_thumbnail)
	{
		float this_width = cur_view.getWidth();
