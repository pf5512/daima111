...
public class Cylinder {
	...
	private static void build_cylinder(View3D icon ,float rotaDeg,float ratio,float this_width,float colora)
	{
		Color color;
		Vector2 old_pos;
	...
	private static void destroy_cylinder(View3D icon ,float rotaDeg,float ratio,float this_width,float colora)
	{
		Color color;
		Vector2 old_pos;
		old_pos = (Vector2)icon.getTag();
	...
	private static void rotate_cylinder(View3D icon ,float degree, float rotaDeg, float des_rotaDeg, float ratio,float this_width)
	{		
		Color color;
		Vector2 old_pos;
		old_pos = (Vector2)icon.getTag();
