...
public class R3D {
	...
	public static int vibrator_duration = 50;
...
//		>0：相对于该图中心点，垂直上移
	...
	public static boolean packHotseat(ShortcutInfo info, boolean needAddBg) {
		String suffix = "";
		...
		if (R3D.packer.getRect(getInfoName(info)) != null
				&& !R3D.packer.getRect(getInfoName(info)).isDefault) {
	...
	//teapotXu_20130328 add end 			
		...
		if (needAddBg) {
			pack(getInfoName(info) + suffix,
					Utils3D.IconToPixmap3D(bmp, info.title.toString(),
							Icon3D.getIconBg(), titleBg), false, isDefault);
		} else {
			pack(getInfoName(info) + suffix, Utils3D.IconToPixmap3D(bmp,
					info.title.toString(), null, titleBg), false, isDefault);
		}
	...
	public static boolean pack(ShortcutInfo info, String suffix) {
		...
		if (info.intent == null || info.intent.getComponent() == null
				|| info.intent.getComponent().getPackageName() == null) {
			...
			if (!doNotNeedScale(null, null)) {
				...
				pack(getInfoName(info) + suffix, Utils3D.IconToPixmap3D(bmp,
						...
						Icon3D.titleBg), false, isDefault);
			} else {
				pack(getInfoName(info) + suffix, Utils3D.IconToPixmap3D(bmp,
						info.title.toString(), Icon3D.getIconBg(),
						Icon3D.titleBg), false, isDefault);
			...
			if (!doNotNeedScale(info.intent.getComponent().getPackageName(),
	...
	public static boolean doNotNeedScale(String pname, String compname) {
	...
	public static boolean pack(ShortcutInfo info) {		
		return pack(info, "");
	}

	public static void pack(ShortcutInfo info, Bitmap p) {
		// Log.e("launcher", "pack2:"+getInfoName(info));
		pack(info, "",p,true);
	}

	public static void pack(ShortcutInfo info, String suffix, Bitmap p) {
		// Log.e("launcher", "pack2:"+getInfoName(info));
		pack(info,suffix, p,true);
	}

	public static void pack(ShortcutInfo info, String suffix, Bitmap p,boolean recycle) {
		// Log.e("launcher", "pack2:"+getInfoName(info));
		pack(getInfoName(info) + suffix, p, recycle,false);
	}
	
	public static void pack(String name, Bitmap p) {
//		pack(name, Utils3D.bmp2Pixmap(p,recycle),isDefault);
		pack(name,p,true,false);
	}
	
	public static void pack(String name, Bitmap p, boolean recycle,boolean isDefault) {
//		pack(name, Utils3D.bmp2Pixmap(p,recycle),isDefault);
	...
	public static AtlasRegion findRegion(ShortcutInfo info) {
	...
	public static AtlasRegion findRegion(ShortcutInfo info, String suffix) {
		AtlasRegion ret = packerAtlas.findRegion(getInfoName(info) + suffix);
		if (ret == null) {
			ret = packerAtlas
					.findRegion(getInfoName(info) + "default" + suffix);
		}
		if (ret == null) {
			Log.e("pack", "region can not be found:" + getInfoName(info));
			ret = findRegion("app-default-icon-with-title");
	...
	public static int getInteger(final String s) {
		...
		//xiatian add start	//adjust third apk icon offset when have iconbg
		if(
				( s.equals("third_apk_icon_offset_x") )
				||( s.equals("third_apk_icon_offset_y") )
				
				//xiatian add start	//folder transform icon offset
				||( s.equals("folder_transform_icon_offset_x") )
				||( s.equals("folder_transform_icon_offset_y") )
				//xiatian add end
	...
	public static void initialize(iLoongLauncher c) {
		...
		app_list_string = r
				.getStringArray(RR.array.app_effects_list_preference);
		workSpace_list_string = r
				.getStringArray(RR.array.workspace_effects_list_preference);
		...
		if (Utils3D.getScreenWidth() > 300
				&& (DefaultLayout.hotseat_hide_title == true || DefaultLayout.hotseat_style_ex == true)) {
		...
		workspace_multicon_width = (int) r
				.getDimension(RR.dimen.multi_icon_width);
		workspace_multicon_height = (int) r
				.getDimension(RR.dimen.multi_icon_height);
		workspace_paopao_big_width = (int) r
				.getDimension(RR.dimen.paopao_big_width);
		workspace_paopao_num_width = (int) r
				.getDimension(RR.dimen.paopao_num_width);
		workspace_paopao_num_height = (int) r
				.getDimension(RR.dimen.paopao_num_height);
		workspace_multiviews_offset = (int) r
				.getDimension(RR.dimen.multi_views_offset3D);
		// icon_title_font = (int) r.getDimension(R.dimen.icon_title_font);
		icon_title_font = Tools.dip2px(iLoongLauncher.getInstance(),
				DefaultLayout.icon_title_font);
		reminder_font = Tools.dip2px(iLoongLauncher.getInstance(),
				DefaultLayout.reminder_font);
		...
		//teapotXu add end for Folder in Mainmenu				
		// zqh start
		app_bar_navigator_audioalbum = r
				.getString(RR.string.app_bar_navigator_audioalbum);
		app_bar_navigator_video = r
				.getString(RR.string.app_bar_navigator_video);
		// app_bar_navigator_application=r.getString(RR.string.app_bar_navigator_application);
		app_bar_navigator_photobucket = r
				.getString(RR.string.app_bar_navigator_photobucket);
		...
		applist_padding_left = (int) r
				.getDimension(RR.dimen.applist_padding_left);
		applist_padding_right = (int) r
				.getDimension(RR.dimen.applist_padding_right);
		applist_padding_left_ex = (int) r
				.getDimension(RR.dimen.applist_padding_left_ex);
		applist_padding_right_ex = (int) r
				.getDimension(RR.dimen.applist_padding_right_ex);
		applist_padding_top = (int) r
				.getDimension(RR.dimen.applist_padding_top);
		applist_padding_bottom = (int) r
				.getDimension(RR.dimen.applist_padding_bottom);
		...
		circle_selectMutiToOperToast = r
				.getString(RR.string.circle_selectMutiToOperToast);
		circle_notSupportToast = r.getString(RR.string.circle_notSupportToast);
		circle_unselectAppIconToast = r
				.getString(RR.string.circle_unselectAppIconToast);
		...
		pageselect_canNotAddWidgetToast = r
				.getString(RR.string.can_not_add_widget);
		pageselect_canNotDeletePage = r
				.getString(RR.string.can_not_delete_page);
		...
		Workspace_celllayout_toppadding = R3D
				.getInteger("celllayout_topPadding");
		Workspace_celllayout_bottompadding = R3D
				.getInteger("celllayout_bottomPadding");
		...
		if (page_indicator_style == 2) {// S2
			page_indicator_size = R3D.getInteger("page_indicator_size_s2");
			page_indicator_focus_w = R3D
					.getInteger("page_indicator_focus_w_s2");
			page_indicator_normal_w = R3D
					.getInteger("page_indicator_normal_w_s2");
		}

		if(DefaultLayout.enable_DesktopIndicatorScroll){
            s4_page_indicator_bg_height = R3D
                    .getInteger("s4_page_indicator_bg_height");
            s4_page_indicator_scroll_width = R3D
                    .getInteger("s4_page_indicator_scroll_width");
            s4_page_indicator_scroll_height = R3D
                    .getInteger("s4_page_indicator_scroll_height");
            s4_page_indicator_number_bg_size = R3D
                    .getInteger("s4_page_indicator_number_bg_size");
		}
		int folder_max_height = Utils3D.getScreenHeight()
				// - R3D.workspace_cell_height - R3D.icongroup_button_height / 2
				- R3D.workspace_cell_height - R3D.folder_group_top_round
				- R3D.icongroup_margin_top - R3D.icongroup_margin_left;
		//zhujieping add
		if (ThemeManager.getInstance().getBoolean("miui_v5_folder")
				|| DefaultLayout.miui_v5_folder) {
			folder_max_num = ThemeManager.getInstance().getInteger(
					"folder_max_num");
			if (folder_max_num <= 0) {
				folder_max_num = folder_group_child_count_x
						* (folder_max_height / R3D.workspace_cell_height);
			}
		} else {
		...
		if (Utils3D.getScreenHeight() < 500) {
			...
			Workspace_celllayout_toppadding = R3D
					.getInteger("celllayout_topPadding_small");
			Workspace_celllayout_bottompadding = R3D
					.getInteger("celllayout_bottomPadding_small");
			page_indicator_focus_w = R3D
					.getInteger("page_indicator_focus_w_small");
			page_indicator_normal_w = R3D
					.getInteger("page_indicator_normal_w_small");
			if (page_indicator_style == 2) {// S2
				// page_indicator_size =
				// R3D.getInteger("page_indicator_size_s2");
				page_indicator_focus_w = R3D
						.getInteger("page_indicator_focus_w_s2_small");
				page_indicator_normal_w = R3D
						.getInteger("page_indicator_normal_w_s2_small");
			}
		}
		...
		Workspace_cell_each_width = Utils3D.getScreenWidth()
				/ R3D.Workspace_cellCountX;
		Workspace_cell_each_height = (Utils3D.getScreenHeight()
				- Workspace_celllayout_toppadding - Workspace_celllayout_bottompadding)
				/ R3D.Workspace_cellCountY;
		/*
		 * 对于QVGA的屏，计算出来的Workspace_cell_each_height还没有workspace_cell_height高，
		 * 动态调整Workspace_cellCountY added by zfshi 2012-11-14
		 */
		if (Utils3D.getScreenHeight() < 400
				&& Workspace_cell_each_height < workspace_cell_height) {
		...
		// xiatian add start //DownloadIcon
		dynamic_menu_download_icon_width = (int) r
				.getDimension(RR.dimen.dynamic_menu_download_icon_width);
		dynamic_menu_download_icon_height = (int) r
				.getDimension(RR.dimen.dynamic_menu_download_icon_height);
		// xiatian add end
...
//				.queryIntentActivities(mainIntent, 0);
		...
		packer = new BitmapPacker(iLoongLauncher.getInstance(),/*packageInfos.size()*/64, 1, false,R3D.filter,R3D.Magfilter,R3D.workspace_cell_width,
				R3D.workspace_cell_height,DefaultLayout.enable_texture_pack,iLoongLauncher.getInstance().mainThreadId,
				iLoongLauncher.getInstance().getApplicationInfo().dataDir+"/");

		pack("app-default-icon", IconCache.makeDefaultIcon());
		pack("app-default-icon-with-title", Utils3D.IconToPixmap3D(
				IconCache.makeDefaultIcon(), iLoongLauncher.getInstance()
						.getResources().getString(RR.string.app_unknow),
				Icon3D.getIconBg(), Icon3D.titleBg));
		pack(R3D.folder3D_name,
				FolderIcon3D.titleToTexture(R3D.folder3D_name, Color.WHITE));
		pack("move_to_left_screen_bar_bg", ThemeManager.getInstance()
				.getBitmap("theme/pack_source/move_to_left_screen_bar_bg.png"));
		pack("move_to_right_screen_bar_bg", ThemeManager.getInstance()
				.getBitmap("theme/pack_source/move_to_right_screen_bar_bg.png"));
		// if(6 == folder_max_num){
		// R3D.pack("folder-maxnumber-" + 6,
		// ThemeManager.getInstance().getBitmap("theme/folder/folder-maxnumber-"+6+".png"));
		// }
		if (8 == folder_max_num) {
			pack("folder-maxnumber-" + 8,
					ThemeManager.getInstance().getBitmap(
							"theme/folder/folder-maxnumber-" + 8 + ".png"));
		}
		if (9 == folder_max_num) {
			pack("folder-maxnumber-" + 9,
					ThemeManager.getInstance().getBitmap(
							"theme/folder/folder-maxnumber-" + 9 + ".png"));
		}
		if (12 == folder_max_num) {
			pack("folder-maxnumber-" + 12, ThemeManager.getInstance()
					.getBitmap("theme/folder/folder-maxnumber-" + 12 + ".png"));
		}
		if (16 == folder_max_num) {
			pack("folder-maxnumber-" + 16, ThemeManager.getInstance()
					.getBitmap("theme/folder/folder-maxnumber-" + 16 + ".png"));
		}
		for (int j = 0; j < folder_max_num; j++) {
			pack("folder-number-" + j,
					ThemeManager.getInstance().getBitmap(
							"theme/folder/folder-number-" + j + ".png"));
		}

		pack("widget-folder-bg2",
				ThemeManager.getInstance().getBitmap(
						"theme/folder/widget-folder-bg2.png"));
		pack("icon_focus",
				ThemeManager.getInstance().getBitmap(
						"theme/pack_source/focus_bg.png"));
		...
		if (ThemeManager.getInstance().getBoolean("miui_v5_folder")
				|| DefaultLayout.miui_v5_folder) {
			Bitmap oriBitmap = ThemeManager.getInstance().getBitmap(
					"theme/folder/folder-open-screen-bg.png");
			Bitmap screenBackBitmap = null;
			if (oriBitmap != null) {
				if (Utils3D.getScreenWidth() != oriBitmap.getWidth()
						|| Utils3D.getScreenHeight() != oriBitmap.getHeight()) {
					screenBackBitmap = Tools
							.resizeBitmap(oriBitmap, Utils3D.getScreenWidth(),
			...
			if (screenBackBitmap != null) {
				screenBackRegion = new TextureRegion(new BitmapTexture(
						screenBackBitmap));
		...
		if(ThemeManager.getInstance().getBoolean("miui_v5_folder")
				|| DefaultLayout.miui_v5_folder){
		    R3D.pack("widget-folder-open-line", ThemeManager.getInstance()
					.getBitmap("theme/pack_source/widget-folder-open-line.png"));
		    R3D.pack(
	                "cursor_patch",
	                ThemeManager.getInstance()
			    	.getBitmap("theme/pack_source/cursor_patch.png"));
		    R3D.pack(
                    "miui-input-ack",
                    ThemeManager.getInstance()
					.getBitmap("theme/miui_source/miui-input-ack.png"));
            R3D.pack(
                    "miui-input-ack-focus",
                    ThemeManager.getInstance()
					.getBitmap("theme/miui_source/miui-input-ack-focus.png"));
            R3D.pack("miui-rename-bg",
                    ThemeManager.getInstance()
					.getBitmap("theme/miui_source/rename-bg.png"));
		}
	...
	private static void initDefaultValue() {
		if (!DefaultLayout.show_icon_size) {
			...
			if (app_icon_size != -1
					&& app_icon_size != DefaultLayout.app_icon_size) {
	...
	public static void initialize2(iLoongLauncher c) {
		...
		// R3D.pack("Contactperson-icon2",
		// ThemeManager.getInstance().getBitmap("theme/pack_source/Contactperson-icon2.png"));
		R3D.pack(
				"control-del-close",
				ThemeManager.getInstance().getBitmap(
						"theme/pack_source/control-del-close.png"));
		R3D.pack(
				"control-del-open",
				ThemeManager.getInstance().getBitmap(
						"theme/pack_source/control-del-open.png"));
		R3D.pack("control-del-Telephone-dial", ThemeManager.getInstance()
				.getBitmap("theme/pack_source/control-del-Telephone-dial.png"));
		R3D.pack("control-del-Telephone-dial2", ThemeManager.getInstance()
				.getBitmap("theme/pack_source/control-del-Telephone-dial2.png"));
		R3D.pack(
				"menu-bg",
				ThemeManager.getInstance().getBitmap(
						"theme/pack_source/menu-bg.png"));
		R3D.pack(
				"menu-tool-button1",
				ThemeManager.getInstance().getBitmap(
						"theme/pack_source/menu-tool-button1.png"));
		R3D.pack(
				"menu-tool-button2",
				ThemeManager.getInstance().getBitmap(
						"theme/pack_source/menu-tool-button2.png"));
		R3D.pack(
				"menu-tool-button3",
				ThemeManager.getInstance().getBitmap(
						"theme/pack_source/menu-tool-button3.png"));
		R3D.pack(
				"menu-user-button1",
				ThemeManager.getInstance().getBitmap(
						"theme/pack_source/menu-user-button1.png"));
		R3D.pack(
				"menu-user-button2",
				ThemeManager.getInstance().getBitmap(
						"theme/pack_source/menu-user-button2.png"));
		R3D.pack(
				"menu-user-button3",
				ThemeManager.getInstance().getBitmap(
						"theme/pack_source/menu-user-button3.png"));
		R3D.pack(
				"page-add-icon",
				ThemeManager.getInstance().getBitmap(
						"theme/pack_source/page-add-icon.png"));
		R3D.pack(
				"page-controlle-a",
				ThemeManager.getInstance().getBitmap(
						"theme/pack_source/page-controlle-a.png"));
		R3D.pack(
				"page-controlle-b",
				ThemeManager.getInstance().getBitmap(
		...
		R3D.pack(
				"page-controlle-c",
				ThemeManager.getInstance().getBitmap(
						"theme/pack_source/page-controlle-c.png"));

		R3D.pack("page-controller-indicator-a", ThemeManager.getInstance()
				.getBitmap("theme/pack_source/page-controller-indicator-a.png"));
		R3D.pack("page-controller-indicator-b", ThemeManager.getInstance()
				.getBitmap("theme/pack_source/page-controller-indicator-b.png"));
		R3D.pack(
				"page-edit3",
				ThemeManager.getInstance().getBitmap(
						"theme/pack_source/page-edit3.png"));
		R3D.pack(
				"public-button-return",
				ThemeManager.getInstance().getBitmap(
						"theme/pack_source/public-button-return.png"));
		R3D.pack("shell-interactive-grid-bg", ThemeManager.getInstance()
				.getBitmap("theme/pack_source/shell-interactive-grid-bg.png"));
		R3D.pack(
				"shell-interactive-grid-scale-button",
				ThemeManager
						.getInstance()
						.getBitmap(
								"theme/pack_source/shell-interactive-grid-scale-button.png"));
		R3D.pack(
				"shell-picker-bg",
				ThemeManager.getInstance().getBitmap(
						"theme/pack_source/shell-picker-bg.png"));
		R3D.pack("shell-picker-connect-line", ThemeManager.getInstance()
				.getBitmap("theme/pack_source/shell-picker-connect-line.png"));
		R3D.pack("shell-picker-menu-item1", ThemeManager.getInstance()
				.getBitmap("theme/pack_source/shell-picker-menu-item1.png"));
		R3D.pack("shell-picker-menu-item2", ThemeManager.getInstance()
				.getBitmap("theme/pack_source/shell-picker-menu-item2.png"));
		R3D.pack("shell-picker-menu-item3a", ThemeManager.getInstance()
				.getBitmap("theme/pack_source/shell-picker-menu-item3a.png"));
		R3D.pack("shell-picker-menu-item3b", ThemeManager.getInstance()
				.getBitmap("theme/pack_source/shell-picker-menu-item3b.png"));
		R3D.pack("shell-picker-menu-item4a", ThemeManager.getInstance()
				.getBitmap("theme/pack_source/shell-picker-menu-item4a.png"));
		R3D.pack("shell-picker-menu-item4b", ThemeManager.getInstance()
				.getBitmap("theme/pack_source/shell-picker-menu-item4b.png"));
		R3D.pack("shell-picker-menu-item5a", ThemeManager.getInstance()
				.getBitmap("theme/pack_source/shell-picker-menu-item5a.png"));
		R3D.pack("shell-picker-menu-item5b", ThemeManager.getInstance()
				.getBitmap("theme/pack_source/shell-picker-menu-item5b.png"));
		R3D.pack("shell-picker-menu-item6a", ThemeManager.getInstance()
				.getBitmap("theme/pack_source/shell-picker-menu-item6a.png"));
		R3D.pack("shell-picker-menu-item6b", ThemeManager.getInstance()
				.getBitmap("theme/pack_source/shell-picker-menu-item6b.png"));
		R3D.pack("shell-picker-menu-item7a", ThemeManager.getInstance()
				.getBitmap("theme/pack_source/shell-picker-menu-item7a.png"));
		R3D.pack(
				"appbar-content-pop-bg",
				ThemeManager.getInstance().getBitmap(
						"theme/pack_source/appbar-content-pop-bg.png"));
		R3D.pack("appbar-popmenu-divider", ThemeManager.getInstance()
				.getBitmap("theme/pack_source/appbar-popmenu-divider.png"));

		R3D.pack("shell-picker-menu-item7b", ThemeManager.getInstance()
				.getBitmap("theme/pack_source/shell-picker-menu-item7b.png"));
		R3D.pack("shell-select-page-bg-select", ThemeManager.getInstance()
				.getBitmap("theme/pack_source/shell-select-page-bg-select.png"));
		R3D.pack(
				"shell-select-page-bg-unselect",
				ThemeManager.getInstance().getBitmap(
						"theme/pack_source/shell-select-page-bg-unselect.png"));
		R3D.pack(
				"tip-point",
				ThemeManager.getInstance().getBitmap(
						"theme/pack_source/tip-point.png"));
		R3D.pack("widget-folder-windows-bg", ThemeManager.getInstance()
				.getBitmap("theme/pack_source/widget-folder-windows-bg.png"));
		R3D.pack(
				"widget-folder-icon",
				ThemeManager.getInstance().getBitmap(
						"theme/pack_source/widget-folder-icon.png"));
		R3D.pack("widget-folder-windows-title", ThemeManager.getInstance()
				.getBitmap("theme/pack_source/widget-folder-windows-title.png"));
		...
		R3D.pack(
				"gardening_crosshairs",
				ThemeManager.getInstance().getBitmap(
						"theme/home/gardening_crosshairs.png"));

		R3D.pack(
				"widget-shortcut-bg",
				ThemeManager.getInstance().getBitmap(
						"theme/pack_source/widget-shortcut-bg.png"));
		...
		if (Utils3D.getScreenHeight() > 700) {
			R3D.pack(
					"page-edit2",
					ThemeManager.getInstance().getBitmap(
							"theme/pack_source/page-edit2.png"));
			R3D.pack(
					"page-edit2b",
					ThemeManager.getInstance().getBitmap(
							"theme/pack_source/page-edit2b.png"));
			R3D.pack(
					"app-menu-button",
					ThemeManager.getInstance().getBitmap(
							"theme/pack_source/app-menu-button.png"));
			R3D.pack("app-menu-downarray", ThemeManager.getInstance()
					.getBitmap("theme/pack_source/app-home-downarray.png"));
			R3D.pack(
					"app-menu-bag",
					ThemeManager.getInstance().getBitmap(
							"theme/pack_source/app-home-bag.png"));
			R3D.pack(
					"app-home-button",
					ThemeManager.getInstance().getBitmap(
							"theme/pack_source/app-home-button.png"));
		} else {
			R3D.pack(
					"page-edit2",
					ThemeManager.getInstance().getBitmap(
							"theme/pack_source/page-edit2-small.png"));
			R3D.pack(
					"page-edit2b",
					ThemeManager.getInstance().getBitmap(
							"theme/pack_source/page-edit2b-small.png"));
			R3D.pack(
					"app-menu-button",
					ThemeManager.getInstance().getBitmap(
							"theme/pack_source/app-menu-button-small.png"));
			R3D.pack(
					"app-menu-downarray",
					ThemeManager.getInstance().getBitmap(
							"theme/pack_source/app-home-downarray-small.png"));
			R3D.pack(
					"app-menu-bag",
					ThemeManager.getInstance().getBitmap(
							"theme/pack_source/app-home-bag-small.png"));
			R3D.pack(
					"app-home-button",
					ThemeManager.getInstance().getBitmap(
							"theme/pack_source/app-home-button-small.png"));
		}
//		R3D.pack(
//				"translucent-bg",
//				ThemeManager.getInstance().getBitmap(
...
//		}
		...
		R3D.pack(
				"app-uninstall",
				ThemeManager.getInstance().getBitmap(
						"theme/pack_source/app-uninstall.png"));
		R3D.pack(
				"appbar-divider",
				ThemeManager.getInstance().getBitmap(
						"theme/pack_source/appbar-divider.png"));
		R3D.pack(
				"appbar-indicator",
				ThemeManager.getInstance().getBitmap(
						"theme/pack_source/appbar-indicator.png"));
		R3D.pack(
				"app-sort-button",
				ThemeManager.getInstance().getBitmap(
						"theme/pack_source/app-sort-button.png"));
		R3D.pack(
				"app-uninstall-button",
				ThemeManager.getInstance().getBitmap(
						"theme/pack_source/app-uninstall-button.png"));
		R3D.pack(
				"app-hide-button",
				ThemeManager.getInstance().getBitmap(
						"theme/pack_source/app-hide-button.png"));

		R3D.pack(
				"appbar-tab-item-music",
				ThemeManager.getInstance().getBitmap(
						"theme/pack_source/res_popup_music.png"));

		R3D.pack(
				"appbar-tab-item-media",
				ThemeManager.getInstance().getBitmap(
						"theme/pack_source/res_popup_media.png"));

		R3D.pack(
				"appbar-tab-item-album",
				ThemeManager.getInstance().getBitmap(
						"theme/pack_source/res_popup_album.png"));
		R3D.pack(
				"appbar-tab-item-app",
				ThemeManager.getInstance().getBitmap(
						"theme/pack_source/res_popup_app.png"));

		R3D.pack("appbar-tab-highlight-item-music", ThemeManager.getInstance()
				.getBitmap("theme/pack_source/res_popup_music_highlight.png"));

		R3D.pack("appbar-tab-highlight-item-media", ThemeManager.getInstance()
				.getBitmap("theme/pack_source/res_popup_media_highlight.png"));

		R3D.pack("appbar-tab-highlight-item-album", ThemeManager.getInstance()
				.getBitmap("theme/pack_source/res_popup_album_highlight.png"));
		R3D.pack("appbar-tab-highlight-item-app", ThemeManager.getInstance()
				.getBitmap("theme/pack_source/res_popup_app_highlight.png"));
		...
		if (DefaultLayout.appbar_show_userapp_list == true) {
			R3D.pack(
					...
					ThemeManager
							.getInstance()
							.getBitmap(
									"theme/pack_source/appbar-show-userapp-navigation-back.png"));
		} else {
			R3D.pack(
					"appbar-navi-back",
					ThemeManager.getInstance().getBitmap(
							"theme/pack_source/appbar-navigation-back.png"));
		}
		R3D.pack("workspace-reflect-view", ThemeManager.getInstance()
				.getBitmap("theme/home/homescreen_blue_strong_holo.png"));
		if (DefaultLayout.trash_icon_pos == TrashIcon3D.TRASH_POS_MIDDLE) {
			R3D.pack(
					"trash-background",
					ThemeManager.getInstance().getBitmap(
							"theme/pack_source/trash-background-middle.png"));
			...
			R3D.pack(
					"trash-background",
					ThemeManager.getInstance().getBitmap(
							"theme/pack_source/trash-background.png"));
		}
//		R3D.pack(
//				"appbar-tab-arrow",
//				ThemeManager.getInstance().getBitmap(
...
//						false, R3D.appbar_tab_color, false));
		// zqh start
		R3D.pack("appbar-tab-navigator-video", AppBar3D.titleToPixmap(
				R3D.app_bar_navigator_video, (int) R3D.appbar_height, false,
				R3D.appbar_tab_color, false));
		R3D.pack("appbar-tab-navigator-audioalbum", AppBar3D.titleToPixmap(
				R3D.app_bar_navigator_audioalbum, (int) R3D.appbar_height,
				false, R3D.appbar_tab_color, false));
		R3D.pack("appbar-tab-navigator-photobucket", AppBar3D.titleToPixmap(
				R3D.app_bar_navigator_photobucket, (int) R3D.appbar_height,
				false, R3D.appbar_tab_color, false));
		R3D.pack("appbar-pop-app", AppBar3D.titleToPixmap(R3D.appbar_tab_app,
				(int) R3D.appbar_height, false, R3D.appbar_menu_color, false));
		R3D.pack("appbar-pop-video", AppBar3D.titleToPixmap(
				R3D.app_bar_navigator_video, (int) R3D.appbar_height, false,
				R3D.appbar_menu_color, false));
		R3D.pack("appbar-pop-audioalbum", AppBar3D.titleToPixmap(
				R3D.app_bar_navigator_audioalbum, (int) R3D.appbar_height,
				false, R3D.appbar_menu_color, false));
		R3D.pack("appbar-pop-photobucket", AppBar3D.titleToPixmap(
				R3D.app_bar_navigator_photobucket, (int) R3D.appbar_height,
				false, R3D.appbar_menu_color, false));
//
//		// zqh end
...
//							Color.parseColor("#FFFFFF"),	//xiatian del
			...
			R3D.pack(R3D.getString(RR.string.edit_mode),  AppBar3D
					.titleToPixmap(R3D.getString(RR.string.edit_mode),
							title_height, false, R3D.applist_menu_color,
					        false));				
			//teapotXu add end for Folder in Mainmenu			
//		} else {
//			R3D.pack(R3D.getString(RR.string.uninstall_app), AppBar3D
...
//		}
		...
		if (DefaultLayout.trash_icon_pos == TrashIcon3D.TRASH_POS_TOP) {
			R3D.pack(
					"xiezai-bg",
					ThemeManager.getInstance().getBitmap(
							"theme/pack_source/xiezai-bg.png"));
			R3D.pack(
					"xiezai-bg2",
					ThemeManager.getInstance().getBitmap(
							"theme/pack_source/xiezai-bg2.png"));
		...
		R3D.pack(
				"folderswidget",
				ThemeManager.getInstance().getBitmap(
						"theme/iconbg/widget-folder-icon.png"));
		int tmpH = (int) ((Utils3D.getScreenHeight() - R3D.appbar_height
				- R3D.applist_padding_top - R3D.applist_padding_bottom) / 3)
				- R3D.app_widget3d_gap;
		for (int i = 1; i < 6; i++) {
			R3D.pack(i + "", AppBar3D.titleToPixmap(i + "",
					(int) (R3D.widget_preview_title_weight * tmpH), false,
					Color.WHITE, true));
		}
		R3D.pack("x", AppBar3D.titleToPixmap("x",
				(int) (R3D.widget_preview_title_weight * tmpH), false,
				Color.WHITE, true));
		R3D.pack("left-bracket", Utils3D.titleToPixmapWidthLimit("(", 1000,
				R3D.photo_title_size, Color.WHITE, 1));
		R3D.pack("right-bracket", Utils3D.titleToPixmapWidthLimit(")", 1000,
				R3D.photo_title_size, Color.WHITE, 1));
		for (int i = 0; i < 10; i++) {
			R3D.pack("photo-" + i, Utils3D.titleToPixmapWidthLimit(i + "",
					1000, R3D.photo_title_size, Color.WHITE, 1));
		}
		R3D.pack(
				"default-video",
				ThemeManager.getInstance().getBitmap(
						"theme/pack_source/default-video.png"));
		R3D.pack(
				"media-unselect",
				ThemeManager.getInstance().getBitmap(
						"theme/pack_source/unselect.png"));
		R3D.pack(
				"media-selected",
				ThemeManager.getInstance().getBitmap(
						"theme/pack_source/selected.png"));
		R3D.pack(
				"default-audio-0",
				ThemeManager.getInstance().getBitmap(
						"theme/pack_source/default-audio-1.png"));
		R3D.pack(
				"default-audio-1",
				ThemeManager.getInstance().getBitmap(
						"theme/pack_source/default-audio-2.png"));
		R3D.pack(
				"default-audio-2",
				ThemeManager.getInstance().getBitmap(
						"theme/pack_source/default-audio-3.png"));
		R3D.pack(
				"default-audio-3",
				ThemeManager.getInstance().getBitmap(
						"theme/pack_source/default-audio-4.png"));
		R3D.pack(
				"default-audio-4",
				ThemeManager.getInstance().getBitmap(
						"theme/pack_source/default-audio-5.png"));
		R3D.pack(
				"default-audio-5",
				ThemeManager.getInstance().getBitmap(
						"theme/pack_source/default-audio-6.png"));
		R3D.pack(
				"default-photo",
				ThemeManager.getInstance().getBitmap(
						"theme/pack_source/default-photo.png"));
		R3D.pack(
				"default-photobucket",
				ThemeManager.getInstance().getBitmap(
						"theme/pack_source/default-photobucket.png"));
		R3D.pack(
				"default-audio-bg",
				ThemeManager.getInstance().getBitmap(
						"theme/pack_source/default-audio-bg.png"));
		R3D.pack(
				"ic_menu_edit",
				ThemeManager.getInstance().getBitmap(
						"theme/pack_source/ic_menu_edit.png"));
