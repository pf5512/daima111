...
public class Widget3DTheme {
	...
	public void setWidgetThemeConfig(String widgetThemeConfig) {
		this.mWidgetThemeConfig = widgetThemeConfig;
	}
	public String getWidget3DThemeName(String packageName, String hostTheme) {
...
//			InputSource xmlin = new InputSource(iLoongLauncher.getInstance().getAssets().open(mWidgetThemeConfig));
			InputSource xmlin = new InputSource(ThemeManager.getInstance().getInputStream(mWidgetThemeConfig));
	...
	class WidgetThemeHandler extends DefaultHandler {
		...
		public void endDocument() throws SAXException {
			...
			if (mWidgetThemeName != null) {
				...
				Log.v(TAG, "find no theme,return default themeName:"
						+ defaultThemeName);
			}
		}
		...
		public void startElement(String namespaceURI, String localName,
			...
			if (localName.equals("widget")) {
				...
				ThemeNode = localName;
				if (ThemeConfigNode.equals("themeConfig")
						&& WidgetNode.equals("widget")) {
				...
				if (ThemeConfigNode.equals("themeConfig")
						&& WidgetNode.equals("widget")
						&& ThemeNode.equals("theme")) {
					if (tmpPackageName.equals(packageName)
							&& hostTheme.equals(atts.getValue("name"))) {
