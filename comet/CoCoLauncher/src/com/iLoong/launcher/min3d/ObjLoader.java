...
public class ObjLoader {
	...
	public static Mesh loadObj(InputStream in, boolean flipV, float offsetX,
		...
		return loadObjFromString(line, flipV, false, offsetX, offsetY, offsetZ,
	...
	public static Mesh loadObj(Gdx gdx, InputStream in, boolean flipV,
		...
		return loadObj(in, flipV, offsetX, offsetY, offsetZ, scaleX, scaleY,
				scaleZ);
	}
	...
	public static Mesh loadObjFromString(String obj, boolean flipV,
		...
		return loadObjFromString(obj, flipV, false, offsetX, offsetY, offsetZ,
				1f, 1f, 1f);
	}
	 ...
	 */
	public static Mesh loadObjFromString(String obj, boolean flipV,
			boolean useIndices, float offsetX, float offsetY, float offsetZ,
		...
		for (int i = 0; i < lines.length; i++) {
			...
			if (line.startsWith("vt")) {
				...
				uv[uvIndex + 1] = flipV ? 1 - Float.parseFloat(tokens[2])
		...
		attributes.add(new VertexAttribute(Usage.Position, 3,
				ShaderProgram.POSITION_ATTRIBUTE));
		attributes.add(new VertexAttribute(Usage.ColorPacked, 4,
				ShaderProgram.COLOR_ATTRIBUTE));
		if (numNormals > 0)
			attributes.add(new VertexAttribute(Usage.Normal, 3,
		...
		if (useIndices) {
			...
			float[] verts = new float[(numFaces * 3)
					* (4 + (numNormals > 0 ? 3 : 0) + (numUV > 0 ? 2 : 0))];
