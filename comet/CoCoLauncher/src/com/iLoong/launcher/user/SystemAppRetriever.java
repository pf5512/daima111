...
public class SystemAppRetriever {
    ...
    Context mContext;
    public SystemAppRetriever(Context context,int delayTimeMillis){
        ...
        preferences = iLoongLauncher.getInstance()
                .getSharedPreferences(SYSTEM_APP_UPDATE_INFO,
    ...
    public static void httpResponseCallback(boolean isComplete){
