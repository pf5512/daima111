...
public class InstallHelpAction extends Action{
	...
	public InstallHelpAction(int actionid, String action) {
		super(actionid, action);
		putIntentAction(SetupMenu.getContext(), ThemeManagerActivity.class);
	}
	
	public static void Init() {
		SetupMenuActions.getInstance().RegisterAction(ActionSetting.ACTION_INSTALL_HELP,
				new InstallHelpAction(ActionSetting.ACTION_INSTALL_HELP, InstallHelpAction.class.getName()));
	}
