...
public abstract class Action {
	...
	public void putIntentAction(Context pkg, Class<?> cls) {
		mComponent = new ComponentName(pkg, cls);
	}

	public void putIntentAction(ComponentName cn) {
		mComponent = cn;
	}
	...
	protected abstract void OnPutValue(String key);
	...
	public static Bitmap getBitmap(int actionid) {
