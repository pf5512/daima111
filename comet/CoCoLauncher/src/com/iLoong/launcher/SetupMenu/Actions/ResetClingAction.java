...
public class ResetClingAction extends Action{
	...
	public ResetClingAction(int actionid, String action) {
		super(actionid, action);
		putIntentAction(SetupMenu.getContext(), ThemeManagerActivity.class);
	}
	
	public static void Init() {
		SetupMenuActions.getInstance().RegisterAction(ActionSetting.ACTION_RESET_WIZARD,
				new ResetClingAction(ActionSetting.ACTION_RESET_WIZARD, ResetClingAction.class.getName()));
	}
