...
public class ScreenEditAction extends Action {
	...
	public ScreenEditAction(int actionid, String action) {
		super(actionid, action);
		putIntentAction(SetupMenu.getContext(), ThemeManagerActivity.class);
	}

	public static void Init() {
		SetupMenuActions.getInstance().RegisterAction(ActionSetting.ACTION_SCREEN_EDITING,
				new ScreenEditAction(ActionSetting.ACTION_SCREEN_EDITING, ScreenEditAction.class.getName()));
	}
