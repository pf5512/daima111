...
public class StatusBarAction extends Action {
	...
	public StatusBarAction(int actionid, String action) {
		super(actionid, action);
		putIntentAction(SetupMenu.getContext(), StatusBarAction.class);
	}

	public static void Init() {
		SetupMenuActions.getInstance().RegisterAction(ActionSetting.ACTION_SHOW_NOTIFICATIONS,
				new StatusBarAction(ActionSetting.ACTION_SHOW_NOTIFICATIONS, StatusBarAction.class.getName()));
	}
