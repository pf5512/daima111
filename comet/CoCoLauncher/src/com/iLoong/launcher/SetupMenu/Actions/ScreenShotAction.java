...
public class ScreenShotAction extends Action {
	...
	public ScreenShotAction(int actionid, String action) {
		super(actionid, action);
		putIntentAction(SetupMenu.getContext(), ThemeManagerActivity.class);
	}

	public static void Init() {
		SetupMenuActions.getInstance().RegisterAction(ActionSetting.ACTION_SCREENSHOT,
				new ScreenShotAction(ActionSetting.ACTION_SCREENSHOT, ScreenShotAction.class.getName()));
	}
