...
public class BackupDesktopAction extends Action {
	...
	public BackupDesktopAction(int actionid, String action) {
		super(actionid, action);
		putIntentAction(SetupMenu.getContext(), BackupActivity.class);
	}

	public static void Init() {
		SetupMenuActions.getInstance().RegisterAction(ActionSetting.ACTION_BACKUP_DESKTOP,
				new BackupDesktopAction(ActionSetting.ACTION_BACKUP_DESKTOP, BackupDesktopAction.class.getName()));
	}
