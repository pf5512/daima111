...
//        v.setPressed(false);   
     ...
     * Draw the view into a bitmap.
     */
    public static Bitmap getViewScaledBitmap(View v,int scaleWidth,int scaleHeight) {
    	...
    	final Bitmap bitmap = Bitmap.createBitmap((int) scaleWidth, (int) scaleHeight,
                Bitmap.Config.ARGB_8888);
...
//        }
    ...
    public static Bitmap resampleIconBitmap(Bitmap bitmap, Context context) {
        synchronized (sCanvas) { // we share the statics :-(
            if (bitmap.getWidth() == sIconWidth && bitmap.getHeight() == sIconHeight) {
                ...
                return createIconBitmap(new BitmapDrawable(bitmap), context, DefaultLayout.app_icon_size);
            }
        }
    }
    ...
    public static void reInitStatics(int app_icon_size)
    {
    ...
    public static Matrix getMarixRotate(Camera c,Matrix outMatrix,int centerX,int centerY,float rotate){
