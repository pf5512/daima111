...
public class Line 
{
	...
	public Line(PointF dirVector, PointF fixPoint)
	{
		makeLineByDirVectorAndFixPoint(dirVector, fixPoint);
	}
	
	public boolean makeLineByDirVectorAndFixPoint(PointF dirVector, PointF fixPoint)
	{
	...
	public boolean makeLineByTwoDifferentPoint(PointF p1, PointF p2)
	{
		if (p1.equals(p2)) 
		{
			return false;			
	...
	public PointF getCross(Line other)
	{
	...
	public float distanceFromPoint(PointF pt)
	{
		float distance = 0.0f;
