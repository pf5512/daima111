...
public class ReusableTexturePool {
	...
	public static ReusableTexturePool getInstance(){
    	if(texturePool == null){
    		synchronized(ReusableTexturePool.class){
    			if(texturePool == null)texturePool = new ReusableTexturePool();
    		}
    	}
    	return texturePool;
    }
	...
	private ReusableTexture create(ReusableTextureHolder holder) {
	...
	public ReusableTexture get(ReusableTextureHolder holder) {
		if(textures.isEmpty()){
	...
	public void free(ReusableTexture texture) {
