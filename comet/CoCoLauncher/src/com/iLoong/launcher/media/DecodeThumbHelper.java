...
public class DecodeThumbHelper {
	...
	public static Bitmap resizeBmp(Bitmap bmp,float minWidth,float minHeight){
		float scale = 1f;
		Bitmap res1;
		Bitmap res2;
		...
		if(bitmapWidth > SCALE_MAX*minWidth)bitmapWidth = (int) (SCALE_MAX*minWidth);
		if(bitmapHeight > SCALE_MAX*minHeight)bitmapHeight = (int) (SCALE_MAX*minHeight);
		if(scale != 1){
