...
public class ActionWeatherClock extends ActionView
{
	...
	public void initView()
	{
		...
		mTitleView.setPosition( this.width-mTitleView.width-10*mScale ,  fixPosY( 129 ));
		...
		nextButton.setPosition( fixPosX(464) ,fixPosY(828)  );
		...
		mHandView1.setPosition(  this.width/2+fixPosX( 40 ), fixPosY( 180,mHandView1 ));
