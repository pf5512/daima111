...
public class ForegroundService extends Service
{
			...
			int startId )
	{
		...
		{
			Notification localNotification = new Notification( 0 , "CoCoLauncher Start" , System.currentTimeMillis() );
			localNotification.setLatestEventInfo( this , "CoCoLauncher " , "CoCoLauncher Start" , PendingIntent.getActivity( this , 0 , new Intent( this , iLoongLauncher.class ) , 0 ) );
