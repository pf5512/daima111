...
//		backgroud.setPosition(0, 0);
		...
		if( DefaultLayout.enable_quick_search && Desktop3DListener.root != null && Desktop3DListener.root.qSearchGroup != null )
		{
			...
			{
				Desktop3DListener.root.qSearchGroup.startResetAnim();
			}
		}
		mVelocityX = 0;
			...
			float y )
	{
		...
		{
			if( ActionHolder.getInstance() != null && ActionData.getInstance().checkValidity() == ActionData.VALIDITY_LOCK_DOCKBAR )
				return true;
		}
