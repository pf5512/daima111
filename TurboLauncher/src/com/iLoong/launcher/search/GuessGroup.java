...
public class GuessGroup extends ViewGroup3D
{
	...
	private void initView()
	{
		...
		try
		{
			Bitmap bgBmp = Tools.getImageFromInStream( iLoongLauncher.getInstance().getAssets().open( "theme/quick_search/qs_guess_bg.9.png" ) );
	...
	class TitleGroup extends ViewGroup3D
	{
				...
				String name )
		{
			...
			try
			{
				lineBmp = Tools.getImageFromInStream( iLoongLauncher.getInstance().getAssets().open( "theme/quick_search/qs_guess_line.9.png" ) );
