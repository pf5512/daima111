...
//		
	...
	public void setDefaultLauncher(){
	 	...
	 	PackageManager p = getPackageManager();
	       ComponentName cN = new ComponentName(iLoongLauncher.getInstance(), FakeLauncher.class);
	...
	public void resetDefault(){
		...
		int flag = ((pm.getComponentEnabledSetting(cN) == PackageManager.COMPONENT_ENABLED_STATE_ENABLED) ? PackageManager.COMPONENT_ENABLED_STATE_DISABLED
