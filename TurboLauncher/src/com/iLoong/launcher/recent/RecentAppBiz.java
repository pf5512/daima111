	...
	public ArrayList<ShortcutInfo>  getClearedList(){
		...
		for(ShortcutInfo info:recentApp){
			...
			for(ShortcutInfo li:lockedApp){
				if(info.intent.getComponent().getClassName().equals( li.intent.getComponent().getClassName() )
						&&info.intent.getComponent().getPackageName().equals( li.intent.getComponent().getPackageName() )){
					locked=true;
				}
			}
			if(!locked){
		...
		for(ShortcutInfo ra:removedApp){
			...
			while(ite.hasNext()){
				...
				if(info.intent.getComponent().getClassName().equals( ra.intent.getComponent().getClassName() )
						&&info.intent.getComponent().getPackageName().equals( ra.intent.getComponent().getPackageName() )){
					ite.remove();
				}
			}
...
//	}
	public void loadRecentApps()
	{
		...
		for(RecentApp ra:recentAppList){
			...
			while(ite.hasNext()){
				...
				if(info.intent.getComponent().getClassName().equals( rainfo.intent.getComponent().getClassName() )
						&&info.intent.getComponent().getPackageName().equals( rainfo.intent.getComponent().getPackageName() )){
					removedApp.add( ra );
				}
			}
	...
	public void addLockeddApp(ShortcutInfo tag){
		Iterator<ShortcutInfo> ite=lockedApp.iterator();
		while(ite.hasNext()){
			ShortcutInfo info =ite.next();
			if(info.intent.getComponent().getClassName().equals( tag.intent.getComponent().getClassName() )
					&&info.intent.getComponent().getPackageName().equals( tag.intent.getComponent().getPackageName() )){
				return ;
			}
		}
	...
	public void deleteApp(ShortcutInfo tag){
		Iterator<ShortcutInfo> ite=lockedApp.iterator();
		while(ite.hasNext()){
			ShortcutInfo info =ite.next();
			if(info.intent.getComponent().getClassName().equals( tag.intent.getComponent().getClassName() )
	...
	public void removeLockedApp(ShortcutInfo tag){
	...
	public void getUsefulData(ArrayList<RecentApp> list){
