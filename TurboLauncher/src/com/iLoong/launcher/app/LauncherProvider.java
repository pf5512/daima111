...
import com.iLoong.launcher.app.LauncherSettings.Favorites;
...
public class LauncherProvider extends ContentProvider
{
	...
	static final String AUTHORITY = RR.getDBAuthority();
	 ...
	 */
	public static final Uri CONTENT_APPWIDGET_RESET_URI = Uri.parse( "content://" + AUTHORITY + "/appWidgetReset" );
	...
	public boolean onCreate()
	{
		...
		( (iLoongApplication)getContext() ).setLauncherProvider( this );
		return true;
	}
	...
	private static class DatabaseHelper extends SQLiteOpenHelper
	{
				...
				Context context )
		{
			...
			mContext = context;
			mAppWidgetHost = new AppWidgetHost( context , iLoongLauncher.APPWIDGET_HOST_ID );
		}
				...
				SQLiteDatabase db )
		{
			...
			db.execSQL( "CREATE TABLE favorites (" + "_id INTEGER PRIMARY KEY," + "title TEXT," + "intent TEXT," + "container INTEGER," + "screen INTEGER," + "cellX INTEGER," + "cellY INTEGER," + "spanX INTEGER," + "spanY INTEGER," + "x INTEGER," + "y INTEGER," + "angle INTEGER," + "itemType INTEGER," + "appWidgetId INTEGER NOT NULL DEFAULT -1," + "isShortcut INTEGER," + "iconType INTEGER," + "iconPackage TEXT," + "iconResource TEXT," + "icon BLOB," + "uri TEXT," + "displayMode INTEGER" + ");" );
			db.execSQL( "CREATE TABLE favorites_big_icon (" + "_id INTEGER PRIMARY KEY," + "title TEXT," + "intent TEXT," + "container INTEGER," + "screen INTEGER," + "cellX INTEGER," + "cellY INTEGER," + "spanX INTEGER," + "spanY INTEGER," + "x INTEGER," + "y INTEGER," + "angle INTEGER," + "itemType INTEGER," + "appWidgetId INTEGER NOT NULL DEFAULT -1," + "isShortcut INTEGER," + "iconType INTEGER," + "iconPackage TEXT," + "iconResource TEXT," + "icon BLOB," + "uri TEXT," + "displayMode INTEGER" + ");" );
			db.execSQL( "CREATE TABLE favorites_small_icon (" + "_id INTEGER PRIMARY KEY," + "title TEXT," + "intent TEXT," + "container INTEGER," + "screen INTEGER," + "cellX INTEGER," + "cellY INTEGER," + "spanX INTEGER," + "spanY INTEGER," + "x INTEGER," + "y INTEGER," + "angle INTEGER," + "itemType INTEGER," + "appWidgetId INTEGER NOT NULL DEFAULT -1," + "isShortcut INTEGER," + "iconType INTEGER," + "iconPackage TEXT," + "iconResource TEXT," + "icon BLOB," + "uri TEXT," + "displayMode INTEGER" + ");" );
				...
				while( c != null && c.moveToNext() )
				{
					...
					if( intentUri != null )
					{
						try
						{
							...
							if( Intent.ACTION_VIEW.equals( intent.getAction() ) && ( data.startsWith( "content://contacts/people/" ) || data
			...
			try
			{
				...
				while( c != null && c.moveToNext() )
				{
					...
					try
					{
						...
						{
							//xujin 适用于api 16+
							UtilsBase.bindAppWidgetId( appWidgetManager , appWidgetId , new ComponentName( "com.android.alarmclock" , "com.android.alarmclock.AnalogAppWidgetProvider" ) );
						...
						{
							//xujin 适用于api 16+
							UtilsBase.bindAppWidgetId( appWidgetManager , appWidgetId , new ComponentName( "com.android.camera" , "com.android.camera.PhotoAppWidgetProvider" ) );
						...
						{
							//xujin 适用于api 16+
							UtilsBase.bindAppWidgetId( appWidgetManager , appWidgetId , getSearchWidgetProvider() );
		...
		{
			ActivityInfo info;
			String packageName = a.getString( RR.styleable.Favorite_packageName );
			String className = a.getString( RR.styleable.Favorite_className );
			try
			{
				ComponentName cn;
				try
		...
		private ComponentName getSearchWidgetProvider()
		{
			...
			//            ComponentName searchComponent = (ComponentName)searchManager.getGlobalSearchActivity();
				...
				PackageManager packageManager )
		{
			...
			if( hasPackage )
			{
				int spanX = a.getInt( RR.styleable.Favorite_spanX , 0 );
				int spanY = a.getInt( RR.styleable.Favorite_spanY , 0 );
		...
		private boolean addUriShortcut(
				SQLiteDatabase db ,
				ContentValues values ,
				TypedArray a )
		{
			Resources r = mContext.getResources();
			final int iconResId = a.getResourceId( RR.styleable.Favorite_icon , 0 );
			final int titleResId = a.getResourceId( RR.styleable.Favorite_title , 0 );
			Intent intent;
			String uri = null;
			try
			{
				uri = a.getString( RR.styleable.Favorite_uri );
