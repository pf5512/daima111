...
public class SendMsgToAndroid {
	...
	public static void vibrator(int ms) {
	...
	public static void startActivity(ItemInfo info) {
		Message msg = new Message();
	...
	public static void sceneLightChange(int brightNess) {
		Message msg = new Message();
	...
	public static void deleteSysWidget(Widget widget) {
		Message msg = new Message();
	...
	public static void sendAddShortcutMsg(int x,int y) {
		Message msg = new Message();
		msg.arg1 = x;
		msg.arg2 = y;
	...
	public static void sendClickToWallPaperMsg(int x,int y) {
		Message msg = new Message();
		msg.arg1 = x;
		msg.arg2 = y;
	...
	public static void sendAddAppWidgetMsg(Widget widget) {
		Message msg = new Message();
	...
	public static void sendWidgetFocusMsg(WidgetPluginView3D widget,int state) {
		Message msg = new Message();
	...
	public static void sendOurToastMsg(String toastString) {
		Message msg = new Message();
		if (toastString != null) {
			Bundle b = new Bundle();
	...
	public static void sendCircleToastMsg(String toastString) {
		Message msg = new Message();
		if (toastString != null) {
			Bundle b = new Bundle();
			b.putString("toastString", toastString);
	...
	public static void sendToastMsg(String toastString){
		Message msg = new Message();
		if (toastString != null) {
			Bundle b = new Bundle();
			b.putString("toastString", toastString);
	...
	public static void sendOurEventMsg(int msgHeader, float x, float y) {
		Message msg = new Message();
		msg.what = msgHeader;
		msg.arg1 = (int) x;
		msg.arg2 = (int) y;
	...
	public static void sendRenameFolderMsg(FolderIcon3D info) {
		Message msg = new Message();
	...
	public static void sendMoveWidgetMsg(View3D view, int screen/* ,int y */) {
		Message msg = new Message();
	...
	public static void addWidgetFromAllApp(ComponentName name, int x ,int y) {
		Message msg = new Message();
	...
	public static void addShortcutFromAllApp(ComponentName name,int x,int y) {
		Message msg = new Message();
	...
	public static void updateTextureAtlasDelay(long packDelay) {
		Message msg = new Message();
	...
	public static void resetTextureWriteDelay(long packDelay) {
		Message msg = new Message();
