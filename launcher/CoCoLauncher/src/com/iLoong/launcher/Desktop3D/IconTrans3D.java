...
public class IconTrans3D extends ViewGroup3D {
	...
	private void findMinAndMax_x_y(List<View3D> mCircleSomething)
	{
	...
	public IconTrans3D(String name )
	{
		super(name);
	...
	private void translateIconGroup(float offsetX,float offsetY)
	{
		...
		buttonOK.setPosition(max_x-buttonOK.getWidth(), 
				max_y-buttonOK.getWidth());
	...
	public void buildElements(List<View3D> circleGroup)
	{
		...
		NinePatch gridbackground = new NinePatch(gridbgTexture,R3D.icongroup_round_radius,R3D.icongroup_round_radius,
