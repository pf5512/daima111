...
public class Elasticity {
	public static void updateEffect(ViewGroup3D cur_view,ViewGroup3D next_view,float degree,float original_degree_touchup, float yScale, float this_width,boolean is_touch_up_effect)
	{
