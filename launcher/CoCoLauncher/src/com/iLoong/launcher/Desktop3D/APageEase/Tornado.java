...
public class Tornado {
	...
	private static void build_tornado(View3D icon ,float rotaDegX,float rotaDeg,float ratio,float scale_x,float this_width,float colora)
	{
		Color color;
		Vector2 old_pos;
	...
	private static void destroy_tornado(View3D icon ,float rotaDegX,float rotaDeg,float ratio,float scale_x,float this_width,float colora)
	{
		Color color;
		Vector2 old_pos;
		old_pos = (Vector2)icon.getTag();
	...
	private static void rotate_tornado(View3D icon ,float degree, float rotaDegX,float rotaDeg, float des_rotaDeg, float ratio,float scale_x,float this_width)
	{		
		Color color;
		Vector2 old_pos;
		old_pos = (Vector2)icon.getTag();
