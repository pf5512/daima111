...
//            Log.v("getTitleAndIcon", "titleBitmap h+"+application.titleBitmap.getHeight()+"w="+application.titleBitmap.getWidth());
//            Log.v("getTitleAndIcon", "iconBitmap h+"+application.iconBitmap.getHeight()+"w="+application.iconBitmap.getWidth());
        }
    }   
    
    public String getLabel(ResolveInfo info){
    ...
    private CacheEntry cacheLocked(ComponentName componentName, ResolveInfo info) {
        ...
        if (entry == null) {
        	...
        	if(entry == null){
                ...
                if(!R3D.doNotNeedScale(appPackName, appClassName))iconSize *= DefaultLayout.thirdapk_icon_scaleFactor;
