...
public class ThemeDetailed extends FrameLayout implements View.OnClickListener,
	...
	private void LoadLayout() {
		...
		mMyTitle.setPadding((int) (COMMON_PADDING * SetupMenu.mScale),
				(int) (COMMON_PADDING * SetupMenu.mScale), 0,
	...
	public void LoadData(int index) {
		...
		int cellheight = (int) (SetupMenu.getInstance().mHeight * 0.7f);
		...
		for (int i = 0; i < count; i++) {
			...
			try {
				...
				bmp = Tools
						.getImageFromInStream(mData
								.getContext()
								.getAssets()
								.open(mData.autoAdaptThemeDir + File.separator
										+ bitmaps.get(i)));
			} catch (IOException e) {
			}
