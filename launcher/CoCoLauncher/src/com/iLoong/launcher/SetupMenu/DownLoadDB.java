...
public class DownLoadDB {
	...
	public boolean HaveRecord(String filename) {
		boolean bhave = false;
		String sql;
	...
	public void Insert(String filename, int len) {
		String sql;
	...
	public void Update(String filename, int downloadbytes) {
		String sql;
	...
	public int getDownLoadBytes(String filename) {
		int downloadbytes = -1;
		String sql;
	...
	public int getDownLoadStartTime(String filename) {
		int starttime = 0;
		String sql;
