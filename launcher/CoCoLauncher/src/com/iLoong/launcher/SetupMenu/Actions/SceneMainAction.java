...
public class SceneMainAction extends Action {
	...
	public SceneMainAction(int actionid, String action) {
		super(actionid, action);
	}

	public static void Init() {
		SetupMenuActions.getInstance().RegisterAction(
				ActionSetting.ACTION_MAIN_MENU,
				new SceneMainAction(ActionSetting.ACTION_MAIN_MENU,
						SceneMainAction.class.getName()));
	}
