...
public class UpdateFeedbackAction extends Action {
	...
	public UpdateFeedbackAction(int actionid, String action) {
		super(actionid, action);
		putIntentAction(SetupMenu.getContext(), UpdateFeedbackSettingActivity.class);
	}

	public static void Init() {
		SetupMenuActions.getInstance().RegisterAction(ActionSetting.ACTION_UPDATE_FEEDBACK,
				new UpdateFeedbackAction(ActionSetting.ACTION_UPDATE_FEEDBACK, UpdateFeedbackAction.class.getName()));
	}
	...
	public static class UpdateFeedbackSettingActivity extends PreferenceActivity implements
