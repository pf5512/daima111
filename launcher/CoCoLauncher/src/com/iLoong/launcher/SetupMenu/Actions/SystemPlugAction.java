...
public class SystemPlugAction extends Action {
	...
	public SystemPlugAction(int actionid, String action) {
		super(actionid, action);
		putIntentAction(SetupMenu.getContext(), SystemPlugAction.class);
	}

	public static void Init() {
		SetupMenuActions.getInstance().RegisterAction(ActionSetting.ACTION_SYSTEM_PLUG,
				new SystemPlugAction(ActionSetting.ACTION_SYSTEM_PLUG, SystemPlugAction.class.getName()));
	}
