...
public class LockEditAction extends Action {
	...
	public LockEditAction(int actionid, String action) {
		super(actionid, action);
		putIntentAction(SetupMenu.getContext(), LockEditAction.class);
	}

	public static void Init() {
		SetupMenuActions.getInstance().RegisterAction(ActionSetting.ACTION_LOCKED_EDITING,
				new LockEditAction(ActionSetting.ACTION_LOCKED_EDITING, LockEditAction.class.getName()));
	}
