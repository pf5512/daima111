...
public class LockerSettingAction extends Action {
	...
	public LockerSettingAction(int actionid, String action) {
	...
	public static void Init() {
		SetupMenuActions.getInstance().RegisterAction(
				ActionSetting.ACTION_LOCKER_SETTING,
				new LockerSettingAction(ActionSetting.ACTION_LOCKER_SETTING,
						LockerSettingAction.class.getName()));
	}
