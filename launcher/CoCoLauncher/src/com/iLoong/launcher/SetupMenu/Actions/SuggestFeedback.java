...
public class SuggestFeedback extends Action {
    ...
    public SuggestFeedback(int actionid, String action){
        super(actionid, action);
    }
    
    public static void Init(){
        SetupMenuActions.getInstance().RegisterAction(ActionSetting.ACTION_SUGGEST_FEEDBACK,
                new SuggestFeedback(ActionSetting.ACTION_SUGGEST_FEEDBACK, SuggestFeedback.class.getName()));
    }
    @Override
