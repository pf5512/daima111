...
public class TestAction extends Action {
    ...
    public TestAction (int actionid, String action){
        super(actionid, action);
        
    }
    
    public static void Init() {
        SetupMenuActions.getInstance().RegisterAction(ActionSetting.ACTION_TEST,
                new TestAction(ActionSetting.ACTION_TEST, TestAction.class.getName()));
    }
    @Override
