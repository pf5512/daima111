...
//	public static final int ITEM_SHORTCUT = 5;
	...
	public AddListAdapter(iLoongLauncher launcher) {
		super();
...
//}
		...
		{
		mItems.add(new ListItem(res, RR.string.group_contacts,
				RR.drawable.ic_contact, ITEM_CONTACT));
		}
		mItems.add(new ListItem(res, RR.string.group_live_folders,
				RR.drawable.ic_folder, ITEM_LIVE_FOLDER));

		mItems.add(new ListItem(res, RR.string.group_widgets,
				RR.drawable.ic_launcher_appwidget, ITEM_APPWIDGET));
		
		mItems.add(new ListItem(res, RR.string.group_shortcuts,
				RR.drawable.ic_launcher_shortcut, ITEM_SHORTCUT));

		mItems.add(new ListItem(res, RR.string.group_wallpapers,
				RR.drawable.ic_launcher_wallpaper_menu, ITEM_WALLPAPER));
	...
	public int getSelectId(int which)
	{
		if (DefaultLayout.workspace_longclick_display_contacts==true)
		{
			return which;
