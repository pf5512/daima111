...
public class UpdateManager {
	public static final String DEFAULT_APK_UPDATE_URL = "http://ku01.coomoe.com/uiv2/getApp.ashx?p01=com.coco.launcher&p06=1";
	public static final String DEFAULT_UPDATE_URL = "http://ku01.coomoe.com/uiv2/getApp.ashx?p01=com.coco.launcher";
	public static final String DOWNLOAD_DIR = Environment
			.getExternalStorageDirectory() + "/coco/download";
	...
	private String getUpdateXml() {
		String url = DEFAULT_UPDATE_URL + "&p02="
				+ getVersionCode(iLoongLauncher.getInstance())
				+ "&p07=com.coco.launcher&p06=2&" + getPhoneParams();
	...
	public boolean isUpdate() {
		// 获取当前软件版本
		if(iLoongLauncher.getInstance() == null)return false;
	 ...
	 * 显示软件更新对话框
	 */
	public void showNoticeDialog(final boolean autoFinish) {
		dialogIsShow = true;
		// 构造对话框
		...
		// 更新
		builder.setPositiveButton(RR.string.soft_update_updatebtn,
				new OnClickListener() {
					@Override
					public void onClick(DialogInterface dialog, int which) {
						...
						downloadAPK(
								...
								"com.coco.launcher",
								"com.coco.launcher",
								iLoongLauncher.getInstance().getString(
										RR.string.coco_launcher_download_name));
						if (autoFinish) {
		...
		// 稍后更新
		builder.setNegativeButton(RR.string.soft_update_later,
				new OnClickListener() {
					@Override
					public void onClick(DialogInterface dialog, int which) {
						dialog.dismiss();
	 ...
	 * 显示软件下载对话框
	 */
	private void showDownloadDialog(final boolean autoFinish) {
		dialogIsShow = true;
		// 构造软件下载对话框
		AlertDialog.Builder builder = new Builder(mContext);
		...
		builder.setView(v);
		// 取消更新
		builder.setNegativeButton(RR.string.soft_update_cancel,
				new OnClickListener() {
					@Override
					public void onClick(DialogInterface dialog, int which) {
						dialog.dismiss();
