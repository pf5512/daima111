...
{
  public static int a1(Context paramContext, String paramString)
  {
    int i = 0;
  ...
  public static PackageInfo a2(Context paramContext, String paramString)
  {
  ...
  public static String a3(Context paramContext)
  {
  ...
  public static String a4(Context paramContext, String paramString)
  {
    String str = "0.0";
    PackageManager localPackageManager = null;
    if (paramString != null)
  ...
  public static String a5(Intent paramIntent)
  {
  ...
  public static List a6(Context paramContext)
  {
    List localList = null;
    PackageManager localPackageManager = paramContext.getPackageManager();
...
//        alj.a();
  ...
  public static void a(Context paramContext, int paramInt1, CharSequence paramCharSequence, int paramInt2)
  {
  ...
  public static void a9(Context paramContext, Intent paramIntent)
  {
  ...
  public static void a10(Context paramContext, Intent paramIntent, int paramInt1, CharSequence paramCharSequence1, CharSequence paramCharSequence2, CharSequence paramCharSequence3, int paramInt2)
  {
    try
    {
  ...
  public static void a11(Context paramContext, Uri paramUri)
  {
    paramContext.startActivity(new Intent("android.intent.action.DELETE", paramUri));
  }

  public static void a12(Context paramContext, String paramString)
  {
    paramContext.startActivity(new Intent("android.intent.action.DELETE", Uri.parse("package:" + paramString)));
  }

  public static void a13(Context paramContext, String paramString1, String paramString2)
  {
    if (!b21(paramContext, paramString1))
      c22(paramContext, paramString2);
  }

  public static boolean a14(ActivityManager paramActivityManager, String paramString1, String paramString2)
  {
	boolean k = false;
  ...
  public static boolean a15(Context paramContext)
  {
    return a17(paramContext, "com.android.vending");
  }

  public static boolean a16(Context paramContext, Intent paramIntent)
  {
	  boolean i = false;
    try
    {
  ...
  public static boolean a17(Context paramContext, String paramString)
  {
    boolean i = false;
  ...
  public static boolean a18(Context paramContext, String paramString1, String paramString2)
  {
    return a14((ActivityManager)paramContext.getSystemService("activity"), paramString1, paramString2);
  }


  public static void b20(Context paramContext, String paramString)
  {
  ...
  public static boolean b21(Context paramContext, String paramString)
  {
    boolean i = false;
  ...
  public static void c22(Context paramContext, String paramString)
  {
  ...
  public static boolean c23(Context paramContext, String paramString)
  {
	  boolean i = false;
    if (paramString == null)
      return i;
