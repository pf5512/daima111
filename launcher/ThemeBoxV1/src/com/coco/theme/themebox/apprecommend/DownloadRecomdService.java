...
public class DownloadRecomdService extends Service {
	...
	private String DOWNLOAD_PATH = Environment
	...
	public void onCreate() {
		...
		if (com.coco.theme.themebox.StaticClass.canDownToInternal) {
			DOWNLOAD_PATH = com.coco.theme.themebox.StaticClass.INTERNAL_PATH + "/CooeeLocker/download/";
		}
		createDownloadPath();
		Log.v("**", "service");
			...
			case DOWNLOAD_COMPLETE: {
				...
				finishNotification.setLatestEventInfo(
						...
						getResources().getString(
								R.string.server_download_finish),
						downCompletedIntent);
	...
	private class DownloadRunnable implements Runnable {
		...
		public DownloadRunnable(String downloadUrl, String downloadFileName) {
			...
			mUpdateNotification = new Notification(R.drawable.logo,
		...
		private long downloadFile(String downloadUrl, File saveFile)
			...
			try {
				...
				if (LoadRecomandActivity.isCWWAPConnect(getApplicationContext())
						&& LoadRecomandActivity.getNetWorkType(getApplicationContext()) != NETTYPE_UNICOM) {
