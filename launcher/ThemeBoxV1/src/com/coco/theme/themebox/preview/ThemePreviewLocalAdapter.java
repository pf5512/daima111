...
public class ThemePreviewLocalAdapter extends BaseAdapter {
	...
	// 构造
	public ThemePreviewLocalAdapter(Context c, ContentConfig cfg, Context dstContext, boolean isfullpreview) {
		mContext = c;
		getConfig(cfg, dstContext);
		isFullPreview = isfullpreview;
	}

	private void getConfig(ContentConfig cfg, Context dstContext) {
