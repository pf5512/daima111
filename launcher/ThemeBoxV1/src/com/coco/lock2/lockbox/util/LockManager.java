...
public class LockManager {
	...
	private static final Uri CURENT_LOCK_URI = Uri.parse("content://"
			+ StaticClass.LOCKBOX_PACKAGE_NAME + "/currentLock");
...
//		resultList.addAll(allMap.values());
	...
	public ComponentName queryCurrentLock() {
		...
		Cursor cursor = contentResolver.query(CURENT_LOCK_URI, null, null,
				null, null);
		...
		String pkgName = cursor.getString(cursor
				.getColumnIndex(FIELD_PACKAGE_NAME));
		String clsName = cursor.getString(cursor
				.getColumnIndex(FIELD_CLASS_NAME));
	...
	public LockInformation queryLock(String packageName, String className) {
