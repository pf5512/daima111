...
public class UpdateManager
{
	...
	{
		String url = DEFAULT_UPDATE_URL + "&p02=" + getVersionCode( iLoongLauncher.getInstance() ) + "&p07=com.coco.launcher&p06=2&" + getPhoneParams();
			...
			final boolean autoFinish )
	{
		...
		builder.setPositiveButton( RR.string.soft_update_updatebtn , new OnClickListener() {
					...
					int which )
			{
				dialog.dismiss();
				// 显示下载对话框
				downloadAPK( mContext , "com.coco.launcher" , "com.coco.launcher" , iLoongLauncher.getInstance().getString( RR.string.coco_launcher_download_name ) );
				if( autoFinish )
				{
