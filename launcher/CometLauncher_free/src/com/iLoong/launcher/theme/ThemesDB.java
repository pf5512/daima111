...
public class ThemesDB
{
	...
	public ThemeConfig getTheme()
	{
		...
		themeconf.theme = prefs.getString( "theme" , "com.cooeecomet.launcher" );
		themeconf.className = prefs.getString( "class_name" , "com.cooeecomet.themes.DefaultActivity1" );
		return themeconf;
	}
			...
			ThemeConfig themeconf )
	{
		...
		prefs.edit().putString( "class_name" , themeconf.className ).commit();
