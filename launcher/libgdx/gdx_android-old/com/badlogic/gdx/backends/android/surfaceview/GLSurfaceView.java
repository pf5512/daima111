    ...
    private class EglHelper {
        ...
        public GL createSurface(SurfaceHolder holder) {
            ...
            try {
				...
				Log.e("EglHelper", "createWindowSurface exception.");
				e.printStackTrace();
			}
            ...
            if (mEglSurface == null || mEglSurface == EGL10.EGL_NO_SURFACE) {
                ...
                Log.e("EglHelper", "createWindowSurface return.");
                return null;
        ...
        public boolean swap() {
            if (! mEgl.eglSwapBuffers(mEglDisplay, mEglSurface)) {
                ...
                case EGL10.EGL_BAD_SURFACE:
                	// This seems to happen if the native window is removed while rendering.
            ...
            if(errorNum > 10)throw new RuntimeException("errorNum>10,restart!");
            return true;
        }
            ...
            try {
                ...
                while (true) {
                    ...
                    try {                    	
		                ...
		                if(!(AndroidGraphics.launcherPause && pauseEglHelper) && AndroidApplication.swapSurface){
		                	if (!mEglHelper.swap()) {
			                    if (LOG_SURFACE) {
	                	...
	                	synchronized (sGLThreadManager) {
		                	if (true) {
		                		Log.w("GLThread", "mRequestPaused== " + mRequestPaused);
		                	}
			                if ( mRequestPaused ) {
			                	continue;                    
			                }		                			               
