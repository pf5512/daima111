...
public class AndroidApplication extends Activity implements Application {
	...
	public volatile boolean releaseGL = false;
	...
	protected void onPause () {
		...
		synchronized(graphics.continue_lock){
			boolean isContinuous = graphics.isContinuousRendering();
			graphics.setContinuousRendering(true);
			Log.v("iLoongLauncher","app onPause0");
			graphics.pause();
			Log.v("iLoongLauncher","app onPause11");
			...
			Log.v("iLoongLauncher","app onPause2");
			graphics.setContinuousRendering(isContinuous);
		}

		if (graphics != null && graphics.view != null && (isFinishing()||releaseGL)) {
			Log.v("iLoongLauncher","app onPause:release");
			if (graphics.view instanceof GLSurfaceViewCupcake) ((GLSurfaceViewCupcake)graphics.view).onPause();
			if (graphics.view instanceof com.badlogic.gdx.backends.android.surfaceview.GLSurfaceView) 
				((com.badlogic.gdx.backends.android.surfaceview.GLSurfaceView)graphics.view).onPause();
		}
		 
		Log.v("iLoongLauncher","app onPause3");
		super.onPause();
	...
	protected void onResume () {
		...
		if (graphics != null && graphics.view != null && releaseGL) {
			if (graphics.view instanceof GLSurfaceViewCupcake) ((GLSurfaceViewCupcake)graphics.view).onResume();
			if (graphics.view instanceof com.badlogic.gdx.backends.android.surfaceview.GLSurfaceView) 
				((com.badlogic.gdx.backends.android.surfaceview.GLSurfaceView)graphics.view).onResume();
		}
