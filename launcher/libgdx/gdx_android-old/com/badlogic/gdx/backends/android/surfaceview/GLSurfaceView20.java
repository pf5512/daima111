...
public class GLSurfaceView20 extends GLSurfaceView {
	...
	private IOnMeasureListener onMeasureListener;

	public IOnMeasureListener getOnMeasureListener() {
		return onMeasureListener;
	}

	public void setOnMeasureListener(IOnMeasureListener onMeasureListener) {
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		ResolutionStrategy.MeasuredDimension measures = resolutionStrategy
				.calcMeasures(widthMeasureSpec, heightMeasureSpec);
		setMeasuredDimension(measures.width, measures.height);
		if (onMeasureListener != null) {
			onMeasureListener.onMeasure(measures.width, measures.height);
		}
	}
