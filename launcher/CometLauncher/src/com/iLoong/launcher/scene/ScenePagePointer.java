			...
			int count )
	{
		...
		for( int j = 0 ; j < count ; j++ )
		{
			...
			if( mvnn != null )
			{
				...
				lp.rightMargin = (int)iLoongLauncher.getInstance().getResources().getDimension( RR.dimen.detile_scene_indi_margint_right );
