...
// <setupmenu row ="2" columns="4" >
// <menu id="0" name="常用" >
// <item id="1001" name="系统插件" icon="m1.png"/>
// <item id="1002" name="壁纸" icon="m2.png"/>
// <item id="1003" name="主题" icon="m3.png"/>
// <item id="1004" name="软件管理" icon="m4.png"/>
// <item id="1005" name="屏幕编辑" icon="m5.png"/>
// <item id="1006" name="桌面设置" icon="m6.png"/>
// <item id="1007" name="系统设置" icon="m7.png"/>
// <item id="1008" name="更新反馈" icon="m8.png"/>
// </menu>
// </setupmenu>
public class ActionSetting
{
	...
	public static final int ACTION_START_SCENE = 1118; // xiatian add
														// //DefaultScene
	...
	//zqh add note: all action ids made later should be greater than 1300(@link ACTION_BASE),its a new start.
	public static final int ACTION_BASE = 1300;
	public static final int ACTION_TEST = 1301;
	public static final int ACTION_DESKTOP_EFFECT = 1302;
	public static final int ACTION_SHOW_DESKTOP = 1303;
	public static final int ACTION_UPDATE_CHECK = 1304;
	public static final int ACTION_SUGGEST_FEEDBACK = 1305;
}
