...
public class PathTool {
	...
	public static String getLockDir() {
		if (com.coco.theme.themebox.StaticClass.canDownToInternal) {
			return com.coco.theme.themebox.StaticClass.INTERNAL_PATH + "/Coco/Lock2";
		}
	...
	public static String getImageDir(String packageName) {
		if (com.coco.theme.themebox.StaticClass.canDownToInternal) {
			return com.coco.theme.themebox.StaticClass.INTERNAL_PATH + "/Coco/Lock2/Image/" + packageName;
		}
		return Environment.getExternalStorageDirectory().getAbsolutePath()
				+ "/Coco/Lock2/Image/" + packageName;
	}

	public static String getDownloadingDir() {
		if (com.coco.theme.themebox.StaticClass.canDownToInternal) {
			return com.coco.theme.themebox.StaticClass.INTERNAL_PATH + "/Coco/Lock2/Downloading";
		}
		return Environment.getExternalStorageDirectory().getAbsolutePath()
				+ "/Coco/Lock2/Downloading";
	}

	public static String getAppDir() {
		if (com.coco.theme.themebox.StaticClass.canDownToInternal) {
			return com.coco.theme.themebox.StaticClass.INTERNAL_PATH + "/Coco/Lock2/App";
		}
		return Environment.getExternalStorageDirectory().getAbsolutePath()
				+ "/Coco/Lock2/App";
	}
	...
	public static String getTempDir() {
		if (com.coco.theme.themebox.StaticClass.canDownToInternal) {
			return com.coco.theme.themebox.StaticClass.INTERNAL_PATH + "/Coco/Lock2/Temp";
		}
		return Environment.getExternalStorageDirectory().getAbsolutePath()
				+ "/Coco/Lock2/Temp";
	}
