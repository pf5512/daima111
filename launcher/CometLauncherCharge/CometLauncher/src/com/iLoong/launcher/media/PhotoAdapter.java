...
public class PhotoAdapter extends MediaListAdapter
{
			...
			float height )
	{
		...
		mCellCountY = (int)( ( height - R3D.applist_padding_bottom - R3D.applist_padding_top - R3D.bottom_bar_height ) / minCellHeight );
		gridPool = new GridPool( 3 , width , height , R3D.bottom_bar_height , mCellCountX , mCellCountY );
	}
	...
	public void setPhotoBucketView(
			PhotoBucketView photoBucketView )
	{
