...
public class DLManager
{
	...
	private void download(
			...
			DownLoadListener dll )
	{
		boolean fromAutoget = DefaultLayout.GetDefaultWidgetFromAutoget( packname , null );
		if( fromAutoget )
		{
			...
			if( file.exists() )
			{
				...
				TabLockFactory.downloadAPK( iLoongLauncher.getInstance() , RR.getPackageName() , packname , title );
		}
