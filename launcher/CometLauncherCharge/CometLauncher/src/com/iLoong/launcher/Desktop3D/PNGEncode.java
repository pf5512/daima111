...
public class PNGEncode
{
	
	public static byte[] toPNG(
			Pixmap pixmap ) throws IOException
	{
	...
	public static byte[] createDataChunk(
			Pixmap pixmap ) throws IOException
	{
...
class ZLIB
{
	...
	private static int calcADLER32(
			byte[] raw )
	{
		int s1 = 1;
		int s2 = 0;
