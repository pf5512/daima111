...
public class R3D
{
			...
			iLoongLauncher c )
	{
		...
		if( iffirst )
		{
			R3D.pack( "beijing" , Tools.getScaledBitmapBySpecifiedRes( 720 , Utils3D.getScreenWidth() , "theme/guid/beijing.jpg" ) );
			R3D.pack( "dian" , Tools.getScaledBitmapBySpecifiedRes( 720 , Utils3D.getScreenWidth() , "theme/guid/dian.png" ) );
			R3D.pack( "dian_click" , Tools.getScaledBitmapBySpecifiedRes( 720 , Utils3D.getScreenWidth() , "theme/guid/dian_click.png" ) );
			R3D.pack( "guid_1_bg" , Tools.getScaledBitmapBySpecifiedRes( 720 , Utils3D.getScreenWidth() , "theme/guid/guid_1_bg.png" ) );
			R3D.pack( "guid_2_bg" , Tools.getScaledBitmapBySpecifiedRes( 720 , Utils3D.getScreenWidth() , "theme/guid/guid_2_bg.png" ) );
			R3D.pack( "guid_3_bg" , Tools.getScaledBitmapBySpecifiedRes( 720 , Utils3D.getScreenWidth() , "theme/guid/guid_3_bg.png" ) );
			R3D.pack( "guid_4_bg" , Tools.getScaledBitmapBySpecifiedRes( 720 , Utils3D.getScreenWidth() , "theme/guid/guid_4_bg.png" ) );
			//			R3D.pack( "guid_5_bg" , ThemeManager.getInstance().getBitmap( "theme/guid/guid_5_bg.png" ) );
			R3D.pack( "guid_6_bg" , Tools.getScaledBitmapBySpecifiedRes( 720 , Utils3D.getScreenWidth() , "theme/guid/guid_6_bg.png" ) );
			//			R3D.pack( "guid_7_bg" , ThemeManager.getInstance().getBitmap( "theme/guid/guid_7_bg.png" ) );
			R3D.pack( "guid_8_bg" , Tools.getScaledBitmapBySpecifiedRes( 720 , Utils3D.getScreenWidth() , "theme/guid/guid_8_bg.png" ) );
			R3D.pack( "guid_9_bg" , Tools.getScaledBitmapBySpecifiedRes( 720 , Utils3D.getScreenWidth() , "theme/guid/guid_9_bg.png" ) );
			if( iLoongLauncher.curLanguage == 0 )
			{
				R3D.pack( "guid_1_title" , Tools.getScaledBitmapBySpecifiedRes( 720 , Utils3D.getScreenWidth() , "theme/guid/guid_1_title_cn.png" ) );
				R3D.pack( "guid_2_title" , Tools.getScaledBitmapBySpecifiedRes( 720 , Utils3D.getScreenWidth() , "theme/guid/guid_2_title_cn.png" ) );
				R3D.pack( "guid_3_title" , Tools.getScaledBitmapBySpecifiedRes( 720 , Utils3D.getScreenWidth() , "theme/guid/guid_3_title_cn.png" ) );
				R3D.pack( "guid_4_title" , Tools.getScaledBitmapBySpecifiedRes( 720 , Utils3D.getScreenWidth() , "theme/guid/guid_4_title_cn.png" ) );
				//				R3D.pack( "guid_5_title" , ThemeManager.getInstance().getBitmap( "theme/guid/guid_5_title_cn.png" ) );
				R3D.pack( "guid_6_title" , Tools.getScaledBitmapBySpecifiedRes( 720 , Utils3D.getScreenWidth() , "theme/guid/guid_6_title_cn.png" ) );
				//				R3D.pack( "guid_7_title" , ThemeManager.getInstance().getBitmap( "theme/guid/guid_7_title_cn.png" ) );
				R3D.pack( "guid_8_title" , Tools.getScaledBitmapBySpecifiedRes( 720 , Utils3D.getScreenWidth() , "theme/guid/guid_8_title_cn.png" ) );
				R3D.pack( "guid_9_title" , Tools.getScaledBitmapBySpecifiedRes( 720 , Utils3D.getScreenWidth() , "theme/guid/guid_9_title_cn.png" ) );
				R3D.pack( "guid_start" , Tools.getScaledBitmapBySpecifiedRes( 720 , Utils3D.getScreenWidth() , "theme/guid/guid_start_cn.png" ) );
			}
			else
			{
				R3D.pack( "guid_1_title" , Tools.getScaledBitmapBySpecifiedRes( 720 , Utils3D.getScreenWidth() , "theme/guid/guid_1_title.png" ) );
				R3D.pack( "guid_2_title" , Tools.getScaledBitmapBySpecifiedRes( 720 , Utils3D.getScreenWidth() , "theme/guid/guid_2_title.png" ) );
				R3D.pack( "guid_3_title" , Tools.getScaledBitmapBySpecifiedRes( 720 , Utils3D.getScreenWidth() , "theme/guid/guid_3_title.png" ) );
				R3D.pack( "guid_4_title" , Tools.getScaledBitmapBySpecifiedRes( 720 , Utils3D.getScreenWidth() , "theme/guid/guid_4_title.png" ) );
				//				R3D.pack( "guid_5_title" , ThemeManager.getInstance().getBitmap( "theme/guid/guid_5_title.png" ) );
				R3D.pack( "guid_6_title" , Tools.getScaledBitmapBySpecifiedRes( 720 , Utils3D.getScreenWidth() , "theme/guid/guid_6_title.png" ) );
				//				R3D.pack( "guid_7_title" , ThemeManager.getInstance().getBitmap( "theme/guid/guid_7_title.png" ) );
				R3D.pack( "guid_8_title" , Tools.getScaledBitmapBySpecifiedRes( 720 , Utils3D.getScreenWidth() , "theme/guid/guid_8_title.png" ) );
				R3D.pack( "guid_9_title" , Tools.getScaledBitmapBySpecifiedRes( 720 , Utils3D.getScreenWidth() , "theme/guid/guid_9_title.png" ) );
				R3D.pack( "guid_start" , Tools.getScaledBitmapBySpecifiedRes( 720 , Utils3D.getScreenWidth() , "theme/guid/guid_start.png" ) );
			}
		}
		//添加文件夹end
		//编辑模式  end
