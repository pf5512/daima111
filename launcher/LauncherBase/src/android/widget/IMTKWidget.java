 ...
 * 
 * The following software/firmware and/or related documentation ("MediaTek Software") have been modified by MediaTek Inc. All revisions are subject to any receiver's applicable license agreements with
 * MediaTek Inc. */
package android.widget;


/**
 * Widget interface for the specified AppWidget.
 * Some special AppWidgets need Launcher send more action details.
 * Here defines some functions will be called in Launcher App.
 * You can implement your view(viewgroup) to handle these details. 
 * <br/>Note: One AppWidget can have only one view(viewgroup) implementing IMTKWidget, 
 * beacuse Launcher App may only search the first IMTKWidget's implementation.
 */
