...
public class PathTool
{
	...
	public static String getLockDir()
	{
		...
		return Environment.getExternalStorageDirectory().getAbsolutePath() + "/Coco/Lock2/";
	}
			...
			String packageName )
	{
		...
		return Environment.getExternalStorageDirectory().getAbsolutePath() + "/Coco/Lock2/Image/" + packageName;
	}
	...
	public static String getDownloadingDir()
	{
		...
		return Environment.getExternalStorageDirectory().getAbsolutePath() + "/Coco/Lock2/Downloading";
	}
	...
	public static String getAppDir()
	{
		...
		return Environment.getExternalStorageDirectory().getAbsolutePath() + "/Coco/Lock2/App";
	}
	...
	public static String getTempDir()
	{
		...
		return Environment.getExternalStorageDirectory().getAbsolutePath() + "/Coco/Lock2/Temp";
	}
