...
public class MainActivity extends Activity
{
			...
			Bundle savedInstanceState )
	{
		...
		mContext = this;
		setContentView( R.layout.comet_layout );
		themeGridViewLocal = (GridView)findViewById( R.id.themeList );
		themeLocalAdapter = new ThemeGridLocalAdapter( mContext );
	...
	private BroadcastReceiver packageReceiver = new BroadcastReceiver() {
				...
				Intent intent )
		{
			...
			if( actionName.equals( Intent.ACTION_PACKAGE_ADDED ) || actionName.equals( Intent.ACTION_PACKAGE_REMOVED ) || actionName.equals( Intent.ACTION_PACKAGE_CHANGED ) )
			{
