...
public class ThemeDescription
{
	...
	private static final String PREVIEW_FILENAME = "preview_config.xml";
	...
	private static final String TAG_THEMEDIR = "theme";
	...
	public Bitmap getDefaultBitmap()
	{
		...
		{
			if( themeimgs.size() > 0 )
				defaultbitmap = Tools.getImageFromInStream( mContext.getAssets().open( themedir + PREVIEW_DIR + themeimgs.get( 0 ) ) );
		}
		catch( IOException e )
		{
			e.printStackTrace();
	...
	/*
	private void getInfo(TextView text) {		
		...
		info += "\n\n";
		info += context.getString(R.string.themeauthor) + "\n" + themeauthor;
		info += "\n\n";
