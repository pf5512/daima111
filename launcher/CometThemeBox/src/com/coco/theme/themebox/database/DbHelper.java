...
public class DbHelper extends SQLiteOpenHelper
{
			...
			SQLiteDatabase db )
	{
		...
		db.execSQL( HotThemeService.getCreateSql() );
		db.execSQL( DownloadThemeService.getCreateSql() );
		db.execSQL( UrlAddressThemeService.getCreateSql() );
	}
			...
			int newVersion )
	{
		...
		db.execSQL( HotThemeService.getDropSql() );
		db.execSQL( HotThemeService.getCreateSql() );
		db.execSQL( DownloadThemeService.getDropSql() );
		db.execSQL( DownloadThemeService.getCreateSql() );
		db.execSQL( UrlAddressThemeService.getDropSql() );
		db.execSQL( UrlAddressThemeService.getCreateSql() );
	}
