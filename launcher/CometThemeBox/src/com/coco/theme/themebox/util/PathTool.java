...
public class PathTool
{
	...
	public static String getThemeDir()
	{
		...
		return Environment.getExternalStorageDirectory().getAbsolutePath() + "/Coco/Theme/";
	}
			...
			String packageName )
	{
		...
		return Environment.getExternalStorageDirectory().getAbsolutePath() + "/Coco/Theme/Image/" + packageName;
	}
	...
	public static String getDownloadingDir()
	{
		...
		return Environment.getExternalStorageDirectory().getAbsolutePath() + "/Coco/Theme/Downloading";
	}
	...
	public static String getAppDir()
	{
		...
		return Environment.getExternalStorageDirectory().getAbsolutePath() + "/Coco/Theme/App";
	}
	...
	public static String getTempDir()
	{
		...
		return Environment.getExternalStorageDirectory().getAbsolutePath() + "/Coco/Theme/Temp";
	}
