...
public class InstallWidgetReceiver {
	...
	public static class WidgetMimeTypeHandlerData {
		...
		public WidgetMimeTypeHandlerData(ResolveInfo rInfo,
	 ...
	 * for a given drop.
	 */
	public static class WidgetListAdapter implements ListAdapter,
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (convertView == null) {
				convertView = mInflater.inflate(
						R.layout.external_widget_drop_list_item, parent, false);
			}
			...
			ImageView i = (ImageView) convertView
					.findViewById(R.id.provider_icon);
			i.setImageDrawable(d);

			// Set the text
			final CharSequence component = resolveInfo
					.loadLabel(packageManager);
			final int[] widgetSpan = new int[2];
			mTargetLayout.rectToCell(widgetInfo.minWidth, widgetInfo.minHeight,
					widgetSpan);
			TextView t = (TextView) convertView.findViewById(R.id.provider);
			t.setText(context.getString(
					R.string.external_drop_widget_pick_format, component,
					widgetSpan[0], widgetSpan[1]));
		...
		public void onClick(DialogInterface dialog, int which) {
			...
			final PendingAddWidgetInfo createInfo = new PendingAddWidgetInfo(
					widgetInfo, mMimeType, mClipData);
