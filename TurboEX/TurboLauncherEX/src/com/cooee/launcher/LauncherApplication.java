...
public class LauncherApplication extends Application {
	...
	public void onCreate() {
		...
		// we want to generate the sharepreferenceUitl as a common tool to keep
		// some availables
		// notice: we should initialize this entity before all launcher
		// initialization
		SharePreferenceUtil.InitPreferenceUtil(this.getApplicationContext());
