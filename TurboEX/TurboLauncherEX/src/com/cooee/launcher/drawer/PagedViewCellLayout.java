...
import com.cooee.uiengine.guiwidgets.PagedView.Page;
...
public class PagedViewCellLayout extends ViewGroup implements Page {
	...
	public void setCellSize(int cellWidth, int cellHeight) {
		...
		mChildren.setCellDimensions(cellWidth, cellHeight);
	}
	...
	public static class LayoutParams extends ViewGroup.MarginLayoutParams {
		...
		public void setup(int cellWidth, int cellHeight, int widthGap,
			...
			if (LauncherApplication.isScreenLarge()) {
				x = hStartPadding + myCellX * (cellWidth + widthGap)
						+ leftMargin;
				y = vStartPadding + myCellY * (cellHeight + heightGap)
						+ topMargin;
			} else {
