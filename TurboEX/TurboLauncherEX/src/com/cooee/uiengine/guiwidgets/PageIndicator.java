...
public class PageIndicator extends LinearLayout {
	...
	public void addMarker(int index, PageMarkerResources marker,
		...
		PageIndicatorMarker m = (PageIndicatorMarker) mLayoutInflater.inflate(
				R.layout.page_indicator_marker, this, false);
	...
	public void addMarkers(ArrayList<PageMarkerResources> markers,
			boolean allowAnimations) {
	...
	void dumpState(String txt) {
		...
		System.out.println("\twindow: [" + mWindowRange[0] + ", "
				+ mWindowRange[1] + "]");
