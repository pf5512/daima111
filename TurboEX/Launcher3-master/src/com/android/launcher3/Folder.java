...
public class Folder extends LinearLayout implements DragSource,
	...
	protected boolean createAndAddShortcut(ShortcutInfo item) {
		...
		textView.setCompoundDrawables(null,
				Utilities.createIconDrawable(item.getIcon(mIconCache)), null,
				null);
	...
	private int getContentAreaHeight() {
		...
		Rect workspacePadding = grid
				.getWorkspacePadding(grid.isLandscape ? CellLayout.LANDSCAPE
						: CellLayout.PORTRAIT);
		int maxContentAreaHeight = grid.availableHeightPx - 4
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		int width = getPaddingLeft() + getPaddingRight()
				+ mContent.getDesiredWidth();
		int height = getFolderHeight();
		int contentAreaWidthSpec = MeasureSpec.makeMeasureSpec(
		...
		mContent.setFixedSize(mContent.getDesiredWidth(),
