...
public class AppsCustomizeTabHost extends TabHost implements
		LauncherTransitionable, TabHost.OnTabChangeListener, Insettable {
	...
	public void setInsets(Rect insets) {
		mInsets.set(insets);
		FrameLayout.LayoutParams flp = (LayoutParams) mContent
				.getLayoutParams();
			...
			public void run() {
				...
				outAnim.addListener(new AnimatorListenerAdapter() {
					private void clearAnimationBuffer() {
						...
						PagedViewWidget
								.setRecyclePreviewsWhenDetachedFromWindow(false);
						mAnimationBuffer.removeAllViews();
						PagedViewWidget
								.setRecyclePreviewsWhenDetachedFromWindow(true);
					}
