...
class ShortcutInfo extends ItemInfo {
	...
	public ShortcutInfo(Context context, ShortcutInfo info) {
		...
		initFlagsAndFirstInstallTime(getPackageInfo(context, intent
	...
	public static PackageInfo getPackageInfo(Context context, String packageName) {
		...
		try {
			...
			Log.d("ShortcutInfo", "PackageManager.getPackageInfo failed for "
					+ packageName);
		}
		return pi;
	}
	 ...
	 *            the launch flags
	 */
	final void setActivity(Context context, ComponentName className,
			int launchFlags) {
	...
	public String toString() {
		return "ShortcutInfo(title=" + title.toString() + "intent=" + intent
				...
				+ this.container + " screen=" + screenId + " cellX=" + cellX
