...
public class LiveWallpaperListAdapter extends BaseAdapter implements
		ListAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			view = mInflater.inflate(
					R.layout.wallpaper_picker_live_wallpaper_item, parent,
					false);
		} else {
			view = convertView;
		}
	...
	public static class LiveWallpaperTile extends
			WallpaperPickerActivity.WallpaperTileInfo {
		private Drawable mThumbnail;
		private WallpaperInfo mInfo;

		public LiveWallpaperTile(Drawable thumbnail, WallpaperInfo info,
				Intent intent) {
		...
		public void onClick(WallpaperPickerActivity a) {
			...
			Utilities.startActivityForResultSafely(a, preview,
					WallpaperPickerActivity.PICK_LIVE_WALLPAPER);
		}
	}
		...
		protected Void doInBackground(List<ResolveInfo>... params) {
			...
			for (ResolveInfo resolveInfo : list) {
				...
				try {
					...
					Log.w(LOG_TAG, "Skipping wallpaper "
				...
				launchIntent.setClassName(info.getPackageName(),
						info.getServiceName());
				LiveWallpaperTile wallpaper = new LiveWallpaperTile(thumb,
						info, launchIntent);
