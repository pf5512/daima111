...
public class Hotseat extends FrameLayout {
	...
	void resetLayout() {
		...
		if (!AppsCustomizePagedView.DISABLE_ALL_APPS) {
			...
			TextView allAppsButton = (TextView) inflater.inflate(
			...
			if (mLauncher != null) {
				allAppsButton.setOnTouchListener(mLauncher
	...
	void addAllAppsFolder(IconCache iconCache, ArrayList<AppInfo> allApps,
		...
		if (AppsCustomizePagedView.DISABLE_ALL_APPS) {
			...
			LauncherModel.addItemToDatabase(launcher, fi, fi.container,
					fi.screenId, fi.cellX, fi.cellY, false);
			FolderIcon folder = FolderIcon.fromXml(R.layout.folder_icon,
					launcher, getLayout(), fi, iconCache);
			workspace.addInScreen(folder, fi.container, fi.screenId, fi.cellX,
					fi.cellY, fi.spanX, fi.spanY);
