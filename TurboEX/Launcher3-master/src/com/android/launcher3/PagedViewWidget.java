...
public class PagedViewWidget extends LinearLayout {
	...
	protected void onDetachedFromWindow() {
		...
		if (sDeletePreviewsWhenDetachedFromWindow) {
			final ImageView image = (ImageView) findViewById(R.id.widget_preview);
			if (image != null) {
				FastBitmapDrawable preview = (FastBitmapDrawable) image
						.getDrawable();
				if (sRecyclePreviewsWhenDetachedFromWindow && mInfo != null
						&& preview != null && preview.getBitmap() != null) {
					mWidgetPreviewLoader.recycleBitmap(mInfo,
							preview.getBitmap());
				}
	...
	public int[] getPreviewSize() {
		...
		maxSize[0] = i.getWidth() - mOriginalImagePadding.left
		...
		if (preview != null) {
			...
			if (mIsAppWidget) {
				...
				image.setPadding(mOriginalImagePadding.left + centerAmount,
						mOriginalImagePadding.top, mOriginalImagePadding.right,
