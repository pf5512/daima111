...
public class DragController {
	...
	public void startDrag(View v, Bitmap bmp, DragSource source,
			Object dragInfo, int dragAction, Point extraPadding,
		...
		startDrag(bmp, dragLayerX, dragLayerY, source, dragInfo, dragAction,
				null, null, initialDragViewScale);
			...
			if (rawDragInfo instanceof ShortcutInfo) {
				...
				for (AppInfo info : appInfos) {
					...
					if (dragInfo != null && dragInfo.intent != null) {
						boolean isSameComponent = dragInfo.intent
								.getComponent().equals(info.componentName);
						if (isSameComponent) {
							cancelDrag();
							return;
						}
