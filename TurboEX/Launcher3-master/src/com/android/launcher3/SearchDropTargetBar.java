 ...
 */
public class SearchDropTargetBar extends FrameLayout implements
	...
	public void setup(Launcher launcher, DragController dragController) {
		...
		if (mEnableDropDownDropTargets) {
			mQSBSearchBarAnim = LauncherAnimUtils.ofFloat(mQSBSearchBar,
	...
	protected void onFinishInflate() {
		...
		mInfoDropTarget = (ButtonDropTarget) mDropTargetBar
				.findViewById(R.id.info_target_text);
		mDeleteDropTarget = (ButtonDropTarget) mDropTargetBar
				.findViewById(R.id.delete_target_text);
	...
	public void showSearchBar(boolean animated) {
		boolean needToCancelOngoingAnimation = mQSBSearchBarAnim.isRunning()
				&& !animated;
	...
	@SuppressLint("NewApi")
	public void onSearchPackagesChanged(boolean searchVisible,
		...
		if (mQSBSearchBar != null) {
			...
			} else if (mPreviousBackground != null
					&& (searchVisible || voiceVisible)) {
