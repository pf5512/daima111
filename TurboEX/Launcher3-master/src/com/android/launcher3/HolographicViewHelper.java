...
public class HolographicViewHelper {
	...
	void generatePressedFocusedStates(ImageView v) {
		if (!mStatesUpdated && v != null) {
			...
			Bitmap outline = createImageWithOverlay(v, mTempCanvas,
					mHighlightColor);
			Bitmap hotword = createImageWithOverlay(v, mTempCanvas,
					mHotwordColor);
	...
	private Bitmap createOriginalImage(ImageView v, Canvas canvas) {
		...
		final Bitmap b = Bitmap.createBitmap(d.getIntrinsicWidth(),
