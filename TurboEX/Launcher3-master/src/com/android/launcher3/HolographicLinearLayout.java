...
public class HolographicLinearLayout extends LinearLayout {
	...
	public HolographicLinearLayout(Context context, AttributeSet attrs,
		...
		TypedArray a = context.obtainStyledAttributes(attrs,
				R.styleable.HolographicLinearLayout, defStyle, 0);
		mImageViewId = a.getResourceId(
				R.styleable.HolographicLinearLayout_sourceImageViewId, -1);
		mHotwordOn = a.getBoolean(
				R.styleable.HolographicLinearLayout_stateHotwordOn, false);
		a.recycle();
