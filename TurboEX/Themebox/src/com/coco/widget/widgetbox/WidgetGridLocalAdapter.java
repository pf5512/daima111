...
public class WidgetGridLocalAdapter extends BaseAdapter {
		...
		public void handleMessage(Message msg) {
			...
			if (!FunctionConfig.isEnable_add_widget()) {
				...
				if (count <= 0) {
					...
					Toast.makeText(context, R.string.widget_local_click_toast,
	...
	public WidgetGridLocalAdapter(Context cxt, DownModule down) {
		context = cxt;
		downThumb = down;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView != null) {
			...
			convertView = View
					.inflate(context, R.layout.main_widget_item, null);
	...
	public class PageItemTask extends
			AsyncTask<WidgetInformation, Integer, WidgetInformation> {

		public PageItemTask() {
		}

		@Override
		protected void onPostExecute(WidgetInformation lockInfo) {
			// TODO Auto-generated method stub
			notifyDataSetChanged();
		}
		...
		@Override
		protected WidgetInformation doInBackground(WidgetInformation... params) {
			// TODO Auto-generated method stub
