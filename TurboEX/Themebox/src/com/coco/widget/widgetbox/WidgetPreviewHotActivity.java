...
public class WidgetPreviewHotActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		btnApply.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				if (FunctionConfig.isEnable_add_widget()) {
					...
					// MobclickAgent.onEvent( mContext , "BoxUninstallWidget" ,
					// packageName );
					removePackage();
				}
			}
			...
			public void onClick(View v) {
				if (com.coco.theme.themebox.StaticClass.canDownToInternal) {
					...
					if (num >= 5) {
						...
						.isAllowDownloadWithToast(WidgetPreviewHotActivity.this)) {
					return;
				}
		...
		butBuy.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				// WidgetPreviewHotActivity.this , paymentInfo );
			}
		});
		// 删除
	...
	private void updateShowStatus() {
		...
		if (!Information.isDownloaded(this)) {
			boolean ispay = Tools.isContentPurchased(this,
					DownloadList.Widget_Type, packageName);
	...
	private void loadWidgetInformation(boolean reloadGallery) {
		...
		if (Information.isInstalled(this)) {
			...
			if (reloadGallery) {
				galleryPreview.setAdapter(new WidgetPreviewLocalAdapter(this,
						packageName, dstContext));
			}
		...
		if (reloadGallery) {
			galleryPreview.setAdapter(new WidgetPreviewHotAdapter(this,
	...
	private void sendShare() {
		...
		intent.putExtra(Intent.EXTRA_TEXT,
				getString(R.string.shareText, Information.getDisplayName()));
		if (saveThumb()) {
	...
	// Toast.makeText( WidgetPreviewHotActivity.this , "计费成功" ,
	// Toast.LENGTH_SHORT ).show();
	// Tools.writePurchasedData( WidgetPreviewHotActivity.this ,
	// DownloadList.Widget_Type , packageName );
	...
	// Toast.makeText( WidgetPreviewHotActivity.this , "计费失败" +
	// paymentInfo.getVersionName() , Toast.LENGTH_SHORT ).show();
	// break;
	// case CooeePaymentResultNotify.COOEE_PAYMENT_RESULT_CANCEL_BY_USER:
	// Toast.makeText( WidgetPreviewHotActivity.this , "用户取消付费" ,
	// Toast.LENGTH_SHORT ).show();
	// break;
	// case 1:
	// Toast.makeText( WidgetPreviewHotActivity.this , "配置免费" ,
	// Toast.LENGTH_SHORT ).show();
	// break;
	// case 2:
	// Toast.makeText( WidgetPreviewHotActivity.this , "不需要重复计费" ,
	// Toast.LENGTH_SHORT ).show();
	// break;
	// case 3:
	// Toast.makeText( WidgetPreviewHotActivity.this , "无可用指令" ,
	// Toast.LENGTH_SHORT ).show();
	// break;
	// }
	// }
