...
public class PathTool {
	...
	public static String getWidgetDir() {
		if (!com.coco.theme.themebox.StaticClass.set_directory_path.equals("")) {
			return com.coco.theme.themebox.StaticClass.set_directory_path
					+ custom_sdcard_root_path + "Widget/";
		}
	...
	public static String getRecommendDir() {
		if (!com.coco.theme.themebox.StaticClass.set_directory_path.equals("")) {
			return com.coco.theme.themebox.StaticClass.set_directory_path
					+ custom_sdcard_root_path + "Widget/recommend";
		}
		return Environment.getExternalStorageDirectory().getAbsolutePath()
				+ custom_sdcard_root_path + "Widget/recommend";
	}
	...
	public static String getImageDir(String packageName) {
		if (!com.coco.theme.themebox.StaticClass.set_directory_path.equals("")) {
			return com.coco.theme.themebox.StaticClass.set_directory_path
					+ custom_sdcard_root_path + "Widget/Image/" + packageName;
		}
		return Environment.getExternalStorageDirectory().getAbsolutePath()
				+ custom_sdcard_root_path + "Widget/Image/" + packageName;
	}
	...
	public static String getDownloadingDir() {
		if (!com.coco.theme.themebox.StaticClass.set_directory_path.equals("")) {
			return com.coco.theme.themebox.StaticClass.set_directory_path
					+ custom_sdcard_root_path + "Widget/Downloading";
		}
		return Environment.getExternalStorageDirectory().getAbsolutePath()
				+ custom_sdcard_root_path + "Widget/Downloading";
	}
	...
	public static String getAppDir() {
		if (!com.coco.theme.themebox.StaticClass.set_directory_path.equals("")) {
			return com.coco.theme.themebox.StaticClass.set_directory_path
					+ custom_sdcard_root_path + "Widget/App";
		}
		return Environment.getExternalStorageDirectory().getAbsolutePath()
				+ custom_sdcard_root_path + "Widget/App";
	}
	...
	public static String getTempDir() {
		if (!com.coco.theme.themebox.StaticClass.set_directory_path.equals("")) {
			return com.coco.theme.themebox.StaticClass.set_directory_path
					+ custom_sdcard_root_path + "Widget/Temp";
		}
		return Environment.getExternalStorageDirectory().getAbsolutePath()
				+ custom_sdcard_root_path + "Widget/Temp";
	}
