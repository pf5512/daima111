...
public class MyDBHelper extends SQLiteOpenHelper {
	...
	public void onCreate(SQLiteDatabase db) throws SQLException {
		...
		db.execSQL("CREATE TABLE IF NOT EXISTS " + Profile.TABLE_NAME + "("
				+ Profile.COLUMN_ITEMTYPE + " TEXT," + Profile.COLUMN_PACKAGE
				+ " TEXT," + Profile.COLUMN_VERSION + " TEXT,"
				+ Profile.COLUMN_ID + " INTEGER PRIMARY KEY AUTOINCREMENT,"
				+ Profile.COLUMN_NAME_CH + " TEXT," + Profile.COLUMN_NAME_EN
				+ " TEXT," + Profile.COLUMN_APK + " TEXT,"
				+ Profile.COLUMN_ICON + " TEXT," + Profile.COLUMN_URL_APK
