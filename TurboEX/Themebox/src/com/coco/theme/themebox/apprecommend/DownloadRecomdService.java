...
public class DownloadRecomdService extends Service {
	...
	private String DOWNLOAD_PATH = Environment.getExternalStorageDirectory()
			+ "/CooeeLocker/download/";
	...
	public void onCreate() {
		...
		if (!com.coco.theme.themebox.StaticClass.set_directory_path.equals("")) {
			DOWNLOAD_PATH = com.coco.theme.themebox.StaticClass.set_directory_path
					+ "/CooeeLocker/download/";
		}
		createDownloadPath();
		Log.v("**", "service");
	...
	public int onStartCommand(Intent intent, int flags, int startId) {
		...
		if (downloadUrl != null && !"".equals(downloadUrl.trim())
			...
			String downloadName = sharedPrefer1.getString(downloadFileName,
					"finish");
		...
		public void handleMessage(Message msg) {
			...
			case DOWNLOAD_FAIL: {
				...
				Notification failNotification = new Notification(
						R.drawable.logo, "", System.currentTimeMillis());
				failNotification.setLatestEventInfo(DownloadRecomdService.this,
						downloadRunnable.mDownloadFileName, getResources()
	...
	private class DownloadRunnable implements Runnable {
		...
		public DownloadRunnable(String downloadUrl, String downloadFileName) {
			...
			mUpdatePendingIntent = PendingIntent.getActivity(
					DownloadRecomdService.this, 0, mUpdateIntent, 0);
			...
			mUpdateNotification.setLatestEventInfo(DownloadRecomdService.this,
		...
		private long downloadFile(String downloadUrl, File saveFile)
			...
			try {
				...
				if (LoadRecomandActivity
						.isCWWAPConnect(getApplicationContext())
						&& LoadRecomandActivity
								.getNetWorkType(getApplicationContext()) != NETTYPE_UNICOM) {
					String host = LoadRecomandActivity
							.getProxyHost(getApplicationContext());
					int port = LoadRecomandActivity
				...
				while ((readsize = is.read(buffer)) > 0) {
					...
					if (curPercent > percentCount || percentCount >= 100) {
						...
						mUpdateNotification.setLatestEventInfo(
								DownloadRecomdService.this, loading + " - "
