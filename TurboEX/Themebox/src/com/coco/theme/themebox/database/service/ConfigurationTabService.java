...
public class ConfigurationTabService {
	...
	public static String getCreateSql() {
		String result = String
				.format("CREATE TABLE %s (%s TEXT PRIMARY KEY, %s TEXT,  %s TEXT,  %s TEXT );",
						TABLE_NAME, FIELD_TYPE, FIELD_ENNAME, FIELD_CNNAME,
						FIELD_TWNAME);
		return result;
	}
	...
	public ConfigurationTabService(Context context) {
	...
	public boolean batchInsert(List<Map<String, String>> list) {
	...
	private Map<String, String> readTabInfo(Cursor cursor) {
		try {
			Map<String, String> item = new HashMap<String, String>();
			item.put(FIELD_TYPE,
					cursor.getString(cursor.getColumnIndexOrThrow(FIELD_TYPE)));
			item.put(FIELD_ENNAME, cursor.getString(cursor
					.getColumnIndexOrThrow(FIELD_ENNAME)));
			item.put(FIELD_CNNAME, cursor.getString(cursor
					.getColumnIndexOrThrow(FIELD_CNNAME)));
			item.put(FIELD_TWNAME, cursor.getString(cursor
					.getColumnIndexOrThrow(FIELD_TWNAME)));
			return item;
