...
public class UIStaticsReceiver extends BroadcastReceiver {
	...
	public void onReceive(Context context, Intent intent) {
		...
		if (Intent.ACTION_PACKAGE_ADDED.equals(action)) {
			...
			if (resid != null) {
				DownloadList.getInstance(context).startUICenterLog(
						DownloadList.ACTION_INSTALL_LOG, resid, packageName);
			}
			Log.v("UIStaticsReceiver", "ACTION_PACKAGE_ADDED----packageName="
					+ packageName);
			...
			if (resid != null) {
				DownloadList.getInstance(context).startUICenterLog(
						DownloadList.ACTION_UNINSTALL_LOG, resid, packageName);
			}
			Log.v("UIStaticsReceiver", "ACTION_PACKAGE_REMOVED----packageName="
					+ packageName);
