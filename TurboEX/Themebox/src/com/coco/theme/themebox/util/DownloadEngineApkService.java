...
public class DownloadEngineApkService extends Service {
	...
	private void notifyManager() {
		...
		if (downApkThread == null) {
			contentView.setTextViewText(R.id.notificationTitle, mContext
					.getResources().getString(R.string.notify_downloading));
		...
		PendingIntent pendingIntent = PendingIntent.getBroadcast(mContext, 0,
				it, 0);
		notification.contentView.setOnClickPendingIntent(R.id.cancel,
				pendingIntent);
	...
	private static boolean findApkDownData(String pkgName, String url) {
	...
	public static boolean isDownload(String pkgname, String url) {
	...
	private void downloadApk(String pkgName, String url) {
	...
	private class DownloadApkThread extends Thread {
		...
		public boolean isPackage(String pkgName, String url) {
		...
		public void run() {
			while (true) {
				...
				String mSavePath = com.coco.theme.themebox.util.PathTool
						.getDownloadDir();
				...
				try {
					...
					File apkFile = new File(mSavePath, curDownApk.packname
							+ ".apk");
	...
	class DownloadNode {
		...
		public DownloadNode(String pkg, String url) {
			this.packname = pkg;
			this.url = url;
		}
	}
