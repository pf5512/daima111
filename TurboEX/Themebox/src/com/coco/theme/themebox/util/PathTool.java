...
public class PathTool {
	...
	public static String getDownloadDir() {
		if (!com.coco.theme.themebox.StaticClass.set_directory_path.equals("")) {
			return com.coco.theme.themebox.StaticClass.set_directory_path
					+ custom_sdcard_root_path + "Download/";
		}
	...
	public static void setCustomRootPath(String customRootPath) {
		if (customRootPath != null) {
			...
			com.coco.wallpaper.wallpaperbox.PathTool
					.setCustomRootPath(customRootPath);
			com.coco.font.fontbox.PathTool.setCustomRootPath(customRootPath);
			com.coco.widget.widgetbox.PathTool
					.setCustomRootPath(customRootPath);
		}
	}
	...
	public static void setProfilePath(String customProfilePath) {
	...
	public static String getRecommendDir() {
		if (!com.coco.theme.themebox.StaticClass.set_directory_path.equals("")) {
			return com.coco.theme.themebox.StaticClass.set_directory_path
					+ custom_sdcard_root_path + "Theme/recommend";
		}
		return Environment.getExternalStorageDirectory().getAbsolutePath()
				+ custom_sdcard_root_path + "Theme/recommend";
	}
	...
	public static String getImageDir(String packageName) {
		if (!com.coco.theme.themebox.StaticClass.set_directory_path.equals("")) {
			return com.coco.theme.themebox.StaticClass.set_directory_path
					+ custom_sdcard_root_path + "Theme/Image/" + packageName;
		}
		return Environment.getExternalStorageDirectory().getAbsolutePath()
				+ custom_sdcard_root_path + "Theme/Image/" + packageName;
	}
	...
	public static String getDownloadingDir() {
		if (!com.coco.theme.themebox.StaticClass.set_directory_path.equals("")) {
			return com.coco.theme.themebox.StaticClass.set_directory_path
					+ custom_sdcard_root_path + "Theme/Downloading";
		}
		return Environment.getExternalStorageDirectory().getAbsolutePath()
				+ custom_sdcard_root_path + "Theme/Downloading";
	}
	...
	public static String getAppDir() {
		if (!com.coco.theme.themebox.StaticClass.set_directory_path.equals("")) {
			return com.coco.theme.themebox.StaticClass.set_directory_path
					+ custom_sdcard_root_path + "Theme/App";
		}
		return Environment.getExternalStorageDirectory().getAbsolutePath()
				+ custom_sdcard_root_path + "Theme/App";
	}
	...
	public static String getTempDir() {
		if (!com.coco.theme.themebox.StaticClass.set_directory_path.equals("")) {
			return com.coco.theme.themebox.StaticClass.set_directory_path
					+ custom_sdcard_root_path + "Theme/Temp";
		}
		return Environment.getExternalStorageDirectory().getAbsolutePath()
				+ custom_sdcard_root_path + "Theme/Temp";
	}
