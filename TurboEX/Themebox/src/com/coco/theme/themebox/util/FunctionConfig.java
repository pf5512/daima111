...
public final class FunctionConfig {
	...
	public static void setEnableUpdateself(boolean enable_update_self) {
		FunctionConfig.enable_update_self = enable_update_self;
	}

	public static void setNetVersion(boolean net_version) {
	...
	public static void setInternal(boolean isInternal) {
		FunctionConfig.isInternal = isInternal;
	}

	public static void setStatusBarTranslucent(boolean bTranslucent,
	...
	public static void setPromptVisible(boolean visible) {
	...
	public static void setWallpaperVisible(boolean visible) {
	...
	public static void setHotLockVisible(boolean hotLockVisible) {
	...
	public static void setFontVisible(boolean isFontVisible) {
		FunctionConfig.isFontVisible = isFontVisible;
	}

	public static void setDisplayLock(boolean visible) {
		displayLock = visible;
	}
	...
	public static void setCustomWallpaperPath(String customWallpaperPath) {
	...
	public static void setdoovStyle(boolean isdoovStyle) {
	...
	public static void setLockSetVisible(boolean isLockSetVisible) {
	...
	public static void setIntroductionVisible(boolean isIntroductionVisible) {
	...
	public static void setGalleryPkg(String galleryPkg) {
	...
	public static void setThemeMoreShow(boolean isThemeMoreShow) {
	...
	public static void setEffectVisiable(boolean isEffectVisiable) {
	...
	public static void setPriceVisible(boolean isPriceVisible) {
	...
	public static void setAppliststring(String[] app_list_string) {
	...
	public static void setWorkSpaceliststring(String[] workSpace_list_string) {
	...
	public static void setLoadingShow(boolean isLoadingShow) {
	...
	public static void setShowSceneTab(boolean isShowSceneTab) {
		if (FunctionConfig.net_version)
	...
	public static void setShowHotScene(boolean isShowHotScene) {
	...
	public static void setShowHotWallpaper(boolean isShowHotWallpaper) {
	...
	public static void setShowWidgetTab(boolean isShowWidgetTab) {
	...
	public static void setShowHotWidget(boolean isShowHotWidget) {
	...
	public static void setShowHotFont(boolean isShowHotFont) {
	...
	public static String getCooeePayID(int price) {
		int p = price / 100;
		if (p < 10) {
			return "U0" + p;
		} else {
	...
	public static String getSmsPurchasedPayID(int price) {
	...
	public static void setLiveWallpaperShow(boolean isLiveWallpaperShow) {
	...
	public static void setThemeVisible(boolean themeVisible) {
	...
	public static void setTab_sequence(String tab_sequence) {
	...
	public static void setTabdefaultHighlight(String tab_default_highlight) {
	...
	public static void setStatictoIcon(boolean isStatictoIcon) {
	...
	public static void setLockwallpaperShow(boolean lockwallpaperShow) {
	...
	public static void setCustomLockWallpaperPath(String customLockWallpaperPath) {
	...
	public static void setEnable_topwise_style(boolean enable_topwise_style) {
	...
	public static void setEnable_tophard_style(boolean enable_tophard_style) {
	...
	public static void setEnable_manual_update(boolean enable_manual_update) {
	...
	public static void setEnable_add_widget(boolean enable_add_widget) {
