...
public class ConfigDB {
	...
	public long insertRecord(String sName, String sValue) {
	...
	public boolean deleteRecord(String sName) {
	...
	public String getRecord(String sName) throws SQLException {
		String result = "";
	...
	public boolean updateRecord(String sName, String sValue) {
