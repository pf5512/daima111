...
public class FontService {
	...
	public FontInformation queryFont(String packageName) {
		DownloadThemeService dSv = new DownloadThemeService(mContext);
	...
	class ByStringValue implements Comparator<FontInformation> {
		...
		@Override
		public int compare(FontInformation lhs, FontInformation rhs) {
	...
	public FontInformation queryFont(String packageName, String className) {
	...
	private List<ApplicationInfo> queryFontListByPackageName(String pkgName) {
		List<ApplicationInfo> resultList = new ArrayList<ApplicationInfo>();
		List<ApplicationInfo> appinfo = mContext.getPackageManager()
	...
	private FontInformation activityToFont(ApplicationInfo activityInfo) {
