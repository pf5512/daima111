...
public class FontMessenger {
	...
	public FontMessenger(ServiceConnected serviceConnected) {
	...
	public boolean bindService(Context context) {
		...
		ComponentName componentName = new ComponentName("com.android.settings",
				"com.android.settings.flipfont.FontStoreService");
	...
	public void applyInterface(int what, String arg) {
		if (!mBound)
			return;
	...
	public String getCurrentSystemFontPackageName(Context context) {
		String pkg = Settings.System.getString(context.getContentResolver(),
				PROP_NAME);
		if (DEBUG)
