...
public class PubProviderHelper {
	...
	public static long insertValue(String table, String name, String value) {
		try {
			ContentResolver resolver = mContext.getContentResolver();
			Uri uri = null;
			if (com.coco.theme.themebox.util.FunctionConfig.personal_center_internal) {
				uri = Uri.parse("content://"
						+ PubContentProvider.LAUNCHER_AUTHORITY + "/" + table);
			} else {
				uri = Uri.parse("content://"
						+ PubContentProvider.PERSONAL_CENTER_AUTHORITY + "/"
						+ table);
			}
	...
	public static int updateValue(String table, String name, String value) {
		try {
			ContentResolver resolver = mContext.getContentResolver();
			Uri uri = null;
			if (com.coco.theme.themebox.util.FunctionConfig.personal_center_internal) {
	...
	public static long insertValue(String authority, String table, String name,
			String value) {
		try {
			ContentResolver resolver = mContext.getContentResolver();
			Uri uri = null;
	...
	public static int updateValue(String authority, String table, String name,
			String value) {
		try {
			ContentResolver resolver = mContext.getContentResolver();
			Uri uri = null;
	...
	public static void addOrUpdateValue(String table, String name, String value) {
		try {
			ContentResolver resolver = mContext.getContentResolver();
			Uri uri = null;
			if (com.coco.theme.themebox.util.FunctionConfig.personal_center_internal) {
	...
	public String queryValue(String table, String name) {
		ContentResolver resolver = mContext.getContentResolver();
		Uri uri = null;
		if (com.coco.theme.themebox.util.FunctionConfig.personal_center_internal) {
			uri = Uri.parse("content://"
	...
	public static void addOrUpdateValue(String authority, String table,
