...
public class LiveWallpaperService extends WallpaperService {
	...
	public LiveWallpaperService(Context context) {
		super(context);
		mContext = context;
	}
	...
	public List<WallpaperInformation> queryDownloadList() {
		...
		List<DownloadThemeItem> downlist = dSv
				.queryTable(DownloadList.LiveWallpaper_Type);
		List<WallpaperInformation> result = new ArrayList<WallpaperInformation>();
	...
	public void queryWallpaper(String packageName, WallpaperInformation infor) {
	...
	public WallpaperInformation queryWallpaper(String packageName,
			String className) {
		if (className != null && !className.equals("")) {
			List<ServiceInfo> installList = queryLiveWallpaperServiceList();
			for (ServiceInfo item : installList) {
	...
	private List<ServiceInfo> queryLiveWallpaperServiceList() {
		...
		List<ResolveInfo> themesinfo = pm.queryIntentServices(intent,
		...
		localIntent1
				.addCategory("com.vlife.coco.intent.category.VLIFE_SET_WALLPAPER");
	...
	private WallpaperInformation serviceToLiveWallpaper(ServiceInfo serviceInfo) {
