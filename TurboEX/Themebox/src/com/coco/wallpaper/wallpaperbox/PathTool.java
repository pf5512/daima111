...
public class PathTool {
	...
	public static void setCustomRootPath(String customRootPath) {
	...
	public static String getWallpaperDir() {
		if (!com.coco.theme.themebox.StaticClass.set_directory_path.equals("")) {
			return com.coco.theme.themebox.StaticClass.set_directory_path
					+ custom_sdcard_root_path + "Wallpaper/";
		}
	...
	public static String getRecommendDir() {
		if (!com.coco.theme.themebox.StaticClass.set_directory_path.equals("")) {
			return com.coco.theme.themebox.StaticClass.set_directory_path
					+ custom_sdcard_root_path + "Wallpaper/recommend";
		}
		return Environment.getExternalStorageDirectory().getAbsolutePath()
				+ custom_sdcard_root_path + "Wallpaper/recommend";
	}

	public static String getImageDir(String packageName) {
		if (!com.coco.theme.themebox.StaticClass.set_directory_path.equals("")) {
			return com.coco.theme.themebox.StaticClass.set_directory_path
					+ custom_sdcard_root_path + "Wallpaper/Image/"
					+ packageName;
		}
		return Environment.getExternalStorageDirectory().getAbsolutePath()
				+ custom_sdcard_root_path + "Wallpaper/Image/" + packageName;
	}

	public static String getDownloadingDir() {
		if (!com.coco.theme.themebox.StaticClass.set_directory_path.equals("")) {
			return com.coco.theme.themebox.StaticClass.set_directory_path
					+ custom_sdcard_root_path + "Wallpaper/Downloading";
		}
		return Environment.getExternalStorageDirectory().getAbsolutePath()
				+ custom_sdcard_root_path + "Wallpaper/Downloading";
	}
	...
	public static String getAppDir() {
		if (!com.coco.theme.themebox.StaticClass.set_directory_path.equals("")) {
			return com.coco.theme.themebox.StaticClass.set_directory_path
					+ custom_sdcard_root_path + "Wallpaper/App";
		}
		return Environment.getExternalStorageDirectory().getAbsolutePath()
				+ custom_sdcard_root_path + "Wallpaper/App";
	}
	...
	public static String getTempDir() {
		if (!com.coco.theme.themebox.StaticClass.set_directory_path.equals("")) {
			return com.coco.theme.themebox.StaticClass.set_directory_path
					+ custom_sdcard_root_path + "Wallpaper/Temp";
		}
		return Environment.getExternalStorageDirectory().getAbsolutePath()
				+ custom_sdcard_root_path + "Wallpaper/Temp";
	}

	public static String getAppFile(String packageName) {
		return getAppDir() + "/" + packageName + ".jpg";
	}

	public static String getAppLiveFile(String packageName) {
		return getAppDir() + "/" + packageName + ".apk";
	}

	public static String getAppSmallFile(String packageName) {
		return getAppDir() + "/" + packageName + "_small.jpg";
	}

	public static String getThumbFile(String packageName) {
		return getImageDir(packageName) + "/thumb.tupian";
	}

	public static String getPreviewDir(String packageName) {
		return getImageDir(packageName) + "/Preview";
	}

	public static String[] getPreviewLists(String packageName) {
	...
	public static String getDownloadingThumb(String packageName) {
		return getDownloadingDir() + "/" + packageName + "_thumb.tmp";
	}

	public static String getDownloadingPreview(String packageName) {
		return getDownloadingDir() + "/" + packageName + "_preview.tmp";
	}

	public static String getDownloadingApp(String packageName) {
	...
	public static void makeDirImage(String packageName) {
		try {
	...
	public static void makePreviewDir(String packageName) {
		try {
