...
public class WallpaperInformation extends ThemeInformation {
	...
	public void copy(WallpaperInformation item) {
	...
	public boolean isDownloadedFinish() {
		...
		if ((file.exists() && small.exists())
				&& (getDownloadStatus() == DownloadStatus.StatusFinish)) {
			return true;
		}
		return false;
	}
	...
	public boolean isDownloaded(Context context) {
		...
		if ((!file.exists() || !small.exists())
			...
			dSv.updateDownloadSizeAndStatus(getPackageName(), 0,
					DownloadStatus.StatusInit, DownloadList.Wallpaper_Type);
			return false;
		}
		return downloaded;
	}

	public boolean isLiveDownloaded(Context context) {
	...
	public void setService(Context cxt, ServiceInfo service) {
