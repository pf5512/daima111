...
public class GalleryIndicator
{
			...
			int count )
	{
		...
		drawCurPage = mContext.getResources().getDrawable( R.drawable.turbo_cur_page );
		drawOtherPage = mContext.getResources().getDrawable( R.drawable.turbo_other_page );
		...
		for( int i = 0 ; i < pageCount ; i++ )
		{
			...
			if( i != 0 )
			{
				lParams.setMargins( dip2px( mContext , 13.5f ) , 0 , 0 , 0 );
			}
