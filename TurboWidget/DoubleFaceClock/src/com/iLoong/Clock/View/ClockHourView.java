...
public class ClockHourView extends Object3DBase
{
	...
	public Mesh getMesh()
	{
		return ClockHelper.getMesh( mMeshCache , mAppContext , WATCH_HOURHAND_OBJ , width / 2 , height / 2 , 0 , WidgetClock.SCALE_X , WidgetClock.SCALE_Y , WidgetClock.SCALE_Z );
	}
