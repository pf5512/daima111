...
public class ImageHelper
{
	 ...
	 * @return
	 */
	public static Bitmap getImageFromRawResource(
			Context paramContext ,
			int resourceId )
	{
		InputStream stream = paramContext.getResources().openRawResource( resourceId );
		Bitmap bitmap = null;
		try
		{
			...
			float toHeight )
	{
		...
		Bitmap virtualBitmap = BitmapFactory.decodeResource( paramContext.getResources() , resourceId , opt );
		virtualBitmap.recycle();
		opt.inSampleSize = computeSampleSize( opt , (int)toWidth );
		opt.inJustDecodeBounds = false;
		try
		{
			virtualBitmap = BitmapFactory.decodeResource( paramContext.getResources() , resourceId , opt );
		}
	...
	public static Bitmap Bytes2Bimap(
			byte[] b )
	{
		if( b.length != 0 )
		{
	...
	public static Drawable bitmapToDrawable(
			Resources resource ,
			Bitmap bitmap )
	{
	 ...
	 */
	public static Bitmap createBitmapThumbnail(
			Bitmap bitmap ,
			int width ,
			int height )
	{
