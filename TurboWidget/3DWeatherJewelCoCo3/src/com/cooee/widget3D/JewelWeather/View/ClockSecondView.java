...
public class ClockSecondView extends PluginViewObject3D {
	private static final String WATCH_SECONDHAND_OBJ = "widget_clock_second.obj";
	...
	public ClockSecondView(String name, MainAppContext appContext,
		...
		super(appContext, name, region, WATCH_SECONDHAND_OBJ);
		...
		this.setMoveOffset(WidgetWeather.MODEL_WIDTH /2+WidgetWeather.mClock_Center_Offset_X, 
				...
				0);
		this.setOrigin(width / 2+WidgetWeather.mClock_Center_Offset_X, height / 2);
