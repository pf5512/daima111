...
public class ClockMinuteBView extends PluginViewObject3D {
	private static final String WATCH_MINUTEHAND_OBJ = "widget_clock_minute_b.obj";
	private Cache<String, Mesh> mMeshCache = null;
	private MainAppContext mAppContext;
	public CooGdx cooGdx;
	public ClockMinuteBView(String name, MainAppContext appContext,
