...
public class ClockSecondBView extends PluginViewObject3D {
	private static final String WATCH_SECONDHAND_OBJ = "widget_clock_second_b.obj";
	private Cache<String, Mesh> mMeshCache = null;
	private MainAppContext mAppContext;
	public CooGdx cooGdx;
	public ClockSecondBView(String name, MainAppContext appContext,
