...
public class ClockMinuteView extends PluginViewObject3D {
	private static final String WATCH_MINUTEHAND_OBJ = "widget_clock_minute.obj";
	...
	public ClockMinuteView(String name, MainAppContext appContext,
		...
		super(appContext, name, region, WATCH_MINUTEHAND_OBJ);
