...
public class TweenTimer {
	...
	private static String TAG = "TweenTimer";
	...
	private TweenTimerListener mTimerListener;
	...
	public TweenTimer(TweenTimerListener listener, int interval) {
...
//		Log.v("ClockTimer", "stop ClockTimer");
	...
	private class TimeTask extends TimerTask {
		public void run() {
			if (!mIsTaskPaused) {
				// Log.v("timetask", "run");
				mTimerListener.tweenTimeChanged();
			}
		}
	}
