...
import com.iLoong.Clean.theme.WidgetAssetFile.AssetFilePrefix;
...
public class WidgetThemeManager {
	...
	public WidgetThemeManager(Context context) {
		mInstance = this;
		mContext = context;
	...
	public InputStream getSysteThemeInputStream(String fileName) {
		return mSystemThemeDescription.getInputStream(false, fileName);
	}

	public InputStream getCurrentThemeInputStream(String fileName) {
		return mThemeDescription.getInputStream(false, fileName);
	}
	...
	public String[] listAssetFiles(String fileDir) {
		...
		apkPath = WidgetThemeManager.getInstance().getCurrentThemeFileDir(fileDir,
				true);
		if (apkPath != null) {
			context = WidgetThemeManager.getInstance().getCurrentThemeContext();
		} else {
			apkPath = WidgetThemeManager.getInstance().getSystemThemeFileDir(fileDir,
					true);
