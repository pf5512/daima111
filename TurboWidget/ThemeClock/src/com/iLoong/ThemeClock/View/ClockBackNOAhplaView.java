...
public class ClockBackNOAhplaView extends Object3DBase {
	public static final String WATCH_BACK_OBJ = "watch_back_no_ahpla.obj";
	private Cache<String, Mesh> mMeshCache = null;
	private MainAppContext mAppContext;
	private Context mThemeContext;
	private ThemeParse mThemeParse;
	public ClockBackNOAhplaView(String name, MainAppContext appContext,
	...
	public Mesh getMesh() {
		Mesh mesh = ClockHelper.getMesh(mMeshCache, mAppContext,mThemeContext,
