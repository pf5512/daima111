...
import com.iLoong.MusicPlay.common.WidgetHelper;
...
public class MusicController
{
	...
	public void startListening()
	{
		...
		commandFilter.addAction( WidgetHelper.getDefaultPkgName( appContext ) + ".playstatechanged" );
	...
	public void nextMusic()
	{
		...
		intent.setPackage( WidgetHelper.getDefaultPkgName( appContext ));
	...
	public synchronized void prevMusic()
	{
		...
		keyEvent = new KeyEvent( KeyEvent.ACTION_DOWN , keyCode );
		meidaButtonIntent.setPackage( WidgetHelper.getDefaultPkgName( appContext ) );
	...
	public class MusicControlIntentReceiver extends BroadcastReceiver
	{
				...
				Intent intent )
		{
			...
			data.playing = intent.getBooleanExtra( "playing" , false );
			if( action.equals( PLAY_STATE_CHANGED ) || action.equals( PLAY_STATE_CHANGED_HTC_G11 ) || action.equals( WidgetHelper.getDefaultPkgName( appContext ) + ".playstatechanged" ) )
			{
				if( data.playing )
				{
					onReceivePlay( data );
