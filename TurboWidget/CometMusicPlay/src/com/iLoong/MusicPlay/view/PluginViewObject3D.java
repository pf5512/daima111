...
/*	
		...
		float cameraZ = (float) (UtilsBase.getScreenHeight() / 2 / Math
				.tan(fieldOfView / 2 * MathUtils.degreesToRadians));
	...
	{
		this.mScaleX = this.mScaleY = this.mScaleZ = WidgetMusicPlayGroup.scale;
	}
	...
	{
		return "theme/widget/" + textureName;
	}
	protected String getThemeTexturePath(String name)
	{
		return "theme/widget/" + name;
	}
