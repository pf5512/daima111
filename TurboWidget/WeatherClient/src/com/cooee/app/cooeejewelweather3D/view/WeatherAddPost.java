...
import com.cooee.app.cooeejewelweather3D.dataentity.SinaCitysEntity;
...
public class WeatherAddPost extends Activity implements OnItemClickListener {
    ...
    private final String CITY_CONTENT_URI = "content://com.cooee.app.cooeejewelweather3D.dataprovider/citys";
				...
				public boolean onTouch(View v, MotionEvent event) {
					...
					ViewHolder holder = new ViewHolder();;
							 ...
							 event.getAction() == MotionEvent.ACTION_MOVE) 
					 {
						 ...
						 holder.textView.setTextSize(18);//22
		                 holder.textView.setTextColor(0x7f7c7c7c);/*0xffa2d853*/
