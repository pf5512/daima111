...
import com.cooee.app.cooeejewelweather3D.component.cityButton;
...
public class WeatherEditPost extends Activity {
	...
	private final String WEATHER_URI = "content://com.cooee.app.cooeejewelweather3D.dataprovider/weather";
	private final String POSTALCODE_URI = "content://com.cooee.app.cooeejewelweather3D.dataprovider/postalCode";
	private final String DATA_SERVICE_ACTION = "com.cooee.app.cooeejewelweather3D.dataprovider.weatherDataService";
		...
		public View getView(final int position, View convertView,
			...
			if (position < (mPoscalCodList.size())) {
				...
				TextView text = (TextView) convertView
						.findViewById(R.id.addtextspace);
