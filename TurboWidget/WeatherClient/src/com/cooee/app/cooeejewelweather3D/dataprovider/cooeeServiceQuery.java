	...
	public static weatherdataentity CooeeWeatherDataUpdate(String city_num) {
		...
		try {
			...
			if (status == 200) {
				...
				com.cooee.app.cooeejewelweather3D.dataprovider.weatherwebservice.Update_Result_Flag = FLAG_UPDATE.UPDATE_SUCCES;
			}
			else
			{
				com.cooee.app.cooeejewelweather3D.dataprovider.weatherwebservice.Update_Result_Flag = FLAG_UPDATE.WEBSERVICE_ERROR;	
			}
		} catch (Exception e) {
	...
	public static weatherdataentity CooeeWeatherParseWeatherData(
		...
		try {
			...
			if (buffer.length > 100) {
				...
				com.cooee.app.cooeejewelweather3D.dataprovider.weatherwebservice.Update_Result_Flag = FLAG_UPDATE.INVILIDE_VALUE;
			}
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
			com.cooee.app.cooeejewelweather3D.dataprovider.weatherwebservice.Update_Result_Flag = FLAG_UPDATE.DATAPROVIDER_ERROR;
		}
		return dataEntity;
	}
